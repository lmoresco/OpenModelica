...
algorithm
  ...
  matchcontinue(in_txt, in_a_equation)
    ...
    case ( txt,
           InstTypes.IF_EQUATION(branches = _) )
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if equation;"));
      then txt;

    case ( txt,
           InstTypes.ASSERT_EQUATION(condition = i_condition, message = i_message) )
      equation
    ...
    case ( txt,
           InstTypes.TERMINATE_EQUATION(message = i_message) )
      equation
        l_msg__str = dumpExp(Tpl.emptyTxt, i_message);
    ...
    case ( txt,
           InstTypes.REINIT_EQUATION(cref = i_cref, reinitExp = i_reinitExp) )
      equation
    ...
    case ( txt,
           InstTypes.NORETCALL_EQUATION(exp = i_exp) )
      equation
