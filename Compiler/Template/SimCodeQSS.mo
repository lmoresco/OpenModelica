  ...
  matchcontinue(in_txt, in_a_simCode, in_a_connections, in_a_qssInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.softNewLine(txt);
        txt = generateSampleBlocks(txt, i_zeroCrossings, a_qssInfo);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "Simulator\n",
                                    "  {\n",
...
algorithm
  ...
  out_txt := fun_33(txt, a_simCode, l_connections, a_qssInfo);
end structureFile;
...
algorithm
  ...
  (out_txt, out_a_varDecls) := lm_36(out_txt, a_zeroCrossings, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_zeroCrossings, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.popBlock(txt);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_40(txt, rest, a_zeroCrossings, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_40(out_txt, a_whenClauses, a_zeroCrossings, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
...
public function generateWhenEquations
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_42(txt, a_whenEq, a_reinits, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = SimCodeC.cref(txt, i_stateVar);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_44(txt, rest, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_44(out_txt, a_reinits, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
end generateReinits;
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp)
    ...
    case ( txt,
           ...
           a_preExp )
      equation
        (txt, a_varDecls, a_preExp) = fun_46(txt, i_e, i_hvar, a_varDecls, a_preExp);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_47(txt, rest, a_varDecls, a_preExp);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  (out_txt, out_a_varDecls, out_a_preExp) := lm_47(out_txt, a_conditions, a_varDecls, a_preExp);
  out_txt := Tpl.popIter(out_txt);
  ...
  matchcontinue(in_txt, in_a_qssInfo, in_a_zeroCrossings, in_a_nStates)
    ...
    case ( txt,
      ...
      equation
        ...
        ret_3 = listLength(a_zeroCrossings);
        ret_4 = intAdd(ret_2, ret_3);
        l_numStatic = Tpl.writeStr(Tpl.emptyTxt, intString(ret_4));
        ret_6 = listLength(i_eqs);
        l_numPureStatic = Tpl.writeStr(Tpl.emptyTxt, intString(ret_6));
        ret_8 = listLength(a_zeroCrossings);
        l_numZeroCross = Tpl.writeStr(Tpl.emptyTxt, intString(ret_8));
        (l_staticFun, l_varDecls) = generateStaticFunc(Tpl.emptyTxt, a_zeroCrossings, l_varDecls, i_DEVSstructure, i_eqs, i_outVarLst, a_nStates);
        ret_11 = listLength(i_eqs);
        (l_zeroCross, l_varDecls) = generateZeroCrossingsEq(Tpl.emptyTxt, ret_11, a_zeroCrossings, l_varDecls, i_DEVSstructure, i_outVarLst, a_nStates);
...
public function functionQssStaticBlocks
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_49(txt, a_qssInfo, a_zeroCrossings, a_nStates);
...
algorithm
  ...
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_51(out_txt, ret_2, a_varLst);
  out_txt := Tpl.popIter(out_txt);
end generateOutputs;
...
algorithm
  ...
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_53(out_txt, ret_0, a_varLst);
  out_txt := Tpl.popIter(out_txt);
end generateInputs;
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_zeroCrossings, in_a_varLst, in_a_nStates, in_a_devsst)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_55(txt, i_eqs, a_varDecls, a_zeroCrossings);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "\n",
        ...
        txt = Tpl.popBlock(txt);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_56(txt, rest, a_varDecls, a_zeroCrossings, a_varLst, a_nStates, a_devsst);
      then (txt, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_56(out_txt, a_BLTblocks, a_varDecls, a_zeroCrossings, a_varLst, a_nStates, a_devsst);
  out_txt := Tpl.popIter(out_txt);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = SimCodeC.error(txt, Tpl.sourceInfo("SimCodeQSS.tpl", 608, 23), Tpl.textString(txt_3));
      then (txt, a_preExp, a_varDecls);
  end matchcontinue;
end generateZCExp;
  ...
  matchcontinue(in_txt, in_items, in_a_varLst, in_a_nStates, in_a_devsst, in_a_offset, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_60(txt, i_relation__, l_zcExp, l_preExp, a_varLst, a_nStates, a_devsst, a_offset, x_i0);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_61(txt, rest, a_varLst, a_nStates, a_devsst, a_offset, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_61(out_txt, a_zeroCrossings, a_varLst, a_nStates, a_devsst, a_offset, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_zeroCrossings)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_63(txt, rest, a_varDecls, a_zeroCrossings);
      then (txt, a_varDecls);
...
algorithm
  ...
  (l_eqs, l_varDecls) := lm_63(l_eqs, a_allEquationsPlusWhen, l_varDecls, a_zeroCrossings);
  ...
  matchcontinue(in_txt, in_a_eq, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_disc, a_varDecls) = lm_65(l_disc, i_discEqs, a_varDecls);
...
public function generateDiscUpdate
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_66(txt, a_eq, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_nStates, in_a_qssInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("  }"));
        txt = Tpl.nextIter(txt);
        txt = lm_70(txt, rest, a_nStates, a_qssInfo);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_qssInfo, in_a_nStates)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_70(txt, i_eqs, a_nStates, i_qssInfo);
        txt = Tpl.popIter(txt);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_a_qssInfo, in_a_varDecls, in_a_preExp, in_a_nStates, in_a_eqs)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("  }"));
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_72(txt, rest, a_qssInfo, a_varDecls, a_preExp, a_nStates, a_eqs);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_qssInfo, in_a_zeroCrossings, in_a_nStates)
    ...
    case ( txt,
      ...
      equation
        ...
        l_preExp = Tpl.emptyTxt;
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, l_varDecls, l_preExp) = lm_72(txt, a_zeroCrossings, i_qssInfo, l_varDecls, l_preExp, a_nStates, i_eqs);
        txt = Tpl.popIter(txt);
      then txt;
...
public function generateZeroCrossingFunctions
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_73(txt, a_qssInfo, a_zeroCrossings, a_nStates);
...
algorithm
  (out_txt, out_a_varDecls, out_a_preExp) :=
  matchcontinue(in_txt, in_a_relation__, in_a_varDecls, in_a_preExp, in_a_i0)
    local
      Tpl.Text txt;
      Tpl.Text a_varDecls;
      Tpl.Text a_preExp;
    ...
    case ( txt,
           ...
           _ )
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("// Sample block skipt"));
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp)
    ...
    case ( txt,
      ...
      equation
        x_i0 = Tpl.getIteri_i0(txt);
        (txt, a_varDecls, a_preExp) = fun_75(txt, i_relation__, a_varDecls, a_preExp, x_i0);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_76(txt, rest, a_varDecls, a_preExp);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_qssInfo, in_a_zeroCrossings)
    ...
    case ( txt,
      ...
      equation
        ...
        l_preExp = Tpl.emptyTxt;
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, l_varDecls, l_preExp) = lm_76(txt, a_zeroCrossings, l_varDecls, l_preExp);
        txt = Tpl.popIter(txt);
      then txt;
...
public function generateCrossingDetector
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_77(txt, a_qssInfo, a_zeroCrossings);
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("Parameters = "));
        txt = Tpl.writeStr(txt, intString(x_i0));
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(".0,2.0,3.0\n"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("  }"));
        txt = Tpl.nextIter(txt);
        txt = lm_79(txt, rest);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_79(out_txt, a_whenClauses);
  out_txt := Tpl.popIter(out_txt);
...
protected function fun_81
  ...
  input BackendQSS.QSSinfo in_a_qssInfo;
  input Integer in_a_i0;
  input DAE.Exp in_a_interval;
  input Tpl.Text in_a_varDecls;
  input Tpl.Text in_a_preExp;
  input DAE.Exp in_a_start;
...
algorithm
  (out_txt, out_a_varDecls, out_a_preExp) :=
  matchcontinue(in_txt, in_a_qssInfo, in_a_i0, in_a_interval, in_a_varDecls, in_a_preExp, in_a_start)
    local
      Tpl.Text txt;
      Integer a_i0;
      DAE.Exp a_interval;
    ...
    case ( txt,
           BackendQSS.QSSINFO(zcSamplesInd = i_zcSamplesInd),
           a_i0,
           a_interval,
           a_varDecls,
           a_preExp,
           a_start )
      equation
        (l_e1, a_preExp, a_varDecls) = SimCodeC.daeExp(Tpl.emptyTxt, a_start, SimCode.contextOther, a_preExp, a_varDecls);
        (l_e2, a_preExp, a_varDecls) = SimCodeC.daeExp(Tpl.emptyTxt, a_interval, SimCode.contextOther, a_preExp, a_varDecls);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "Simulator\n",
                                    "  {\n"
                                }, true));
        ...
        txt = Tpl.writeStr(txt, intString(a_i0));
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(".0, "));
        ret_2 = listNth(i_zcSamplesInd, a_i0);
...
algorithm
  (out_txt, out_a_varDecls, out_a_preExp) :=
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_qssInfo)
    local
      Tpl.Text txt;
      list<BackendDAE.ZeroCrossing> rest;
      Tpl.Text a_varDecls;
    ...
    case ( txt,
      ...
      equation
        x_i0 = Tpl.getIteri_i0(txt);
        (txt, a_varDecls, a_preExp) = fun_81(txt, a_qssInfo, x_i0, i_interval, a_varDecls, a_preExp, i_start);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_82(txt, rest, a_varDecls, a_preExp, a_qssInfo);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  l_preExp := Tpl.emptyTxt;
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, l_varDecls, l_preExp) := lm_82(out_txt, a_zeroCrossings, l_varDecls, l_preExp, a_qssInfo);
  out_txt := Tpl.popIter(out_txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        l_dirExtra = fun_88(Tpl.emptyTxt, i_modelInfo_directory);
        l_libsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(" ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        l_libsStr = lm_89(l_libsStr, i_makefileParams_libs);
        l_libsStr = Tpl.popIter(l_libsStr);
        l_libsPos1 = fun_90(Tpl.emptyTxt, l_dirExtra, l_libsStr);
        l_libsPos2 = fun_91(Tpl.emptyTxt, l_dirExtra, l_libsStr);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(": "));
        txt = Tpl.writeStr(txt, i_fileNamePrefix);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(".conv.cpp model_functions.cpp model_functions.h model_records.c\n"));
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("\t"));
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" $(CXX) -I. -o "));
        txt = Tpl.writeStr(txt, i_fileNamePrefix);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("$(EXEEXT) "));
        txt = Tpl.writeStr(txt, i_fileNamePrefix);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(".conv.cpp model_functions.cpp "));
...
algorithm
  ...
  out_txt := lm_98(out_txt, a_literals);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
...
algorithm
  ...
  out_txt := lm_100(out_txt, a_conns);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING(" };"));
...
algorithm
  ...
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(",")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_102(out_txt, a_vars__tuple);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       " };\n",
                                       "int inputRows = "
