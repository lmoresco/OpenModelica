...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_42(out_txt, a_functions, a_simCode);
  out_txt := Tpl.popIter(out_txt);
  ...
  matchcontinue(in_txt, in_a_fn, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_48(txt, i_outVars, a_simCode);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" >  "));
  ...
  matchcontinue(in_txt, in_a_fn, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_51(txt, i_functionArguments, a_simCode);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.popBlock(txt);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varInits, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varInits, a_varDecls) = lm_56(txt, rest, a_simCode, a_varInits, a_varDecls);
      then (txt, a_varInits, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_57(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_outVarAssign, in_a_outVarCopy, in_a_outVarInits, in_a_varDecls, in_a_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_outVarAssign, a_outVarCopy, a_outVarInits, a_varDecls) = lm_58(txt, rest, a_simCode, a_outVarAssign, a_outVarCopy, a_outVarInits, a_varDecls, a_fn);
      then (txt, a_outVarAssign, a_outVarCopy, a_outVarInits, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_inFunc, in_a_retType, in_a_outVars, in_a_simCode, in_a_functionArguments, in_a_fname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = lm_61(txt, a_functionArguments, a_simCode);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_62(txt, a_outVars, a_retType);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "\n",
                                    "//MMC_TRY_TOP()\n",
  ...
  matchcontinue(in_txt, in_a_fn, in_a_inFunc, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        l_fname = underscorePath(Tpl.emptyTxt, i_name);
        l_retType = fun_55(Tpl.emptyTxt, i_outVars, l_fname);
        ...
        (l_0__, l_varInits, l_varDecls) = lm_56(l_0__, i_variableDeclarations, a_simCode, l_varInits, l_varDecls);
        ...
        (l_bodyPart, l_varDecls) = lm_57(l_bodyPart, i_body, a_simCode, l_varDecls);
        ...
        (l_0___1, l_outVarAssign, l_outVarCopy, l_outVarInits, l_varDecls) = lm_58(l_0___1, i_outVars, a_simCode, l_outVarAssign, l_outVarCopy, l_outVarInits, l_varDecls, i_fn);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_59(txt, i_functionArguments, a_simCode);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    ")\n",
                                    "{\n"
        ...
        txt = fun_60(txt, i_outVars, l_fname);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(";\n"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "}\n",
        ...
        txt = fun_63(txt, a_inFunc, l_retType, i_outVars, a_simCode, i_functionArguments, l_fname);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "\n",
                                    "\n"
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_varInits)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_varInits) = lm_66(txt, rest, a_simCode, a_varDecls, a_varInits);
      then (txt, a_varDecls, a_varInits);
  ...
  matchcontinue(in_txt, in_a_var, in_a_ix, in_a_varInits, in_a_fname, in_a_varAssign, in_a_simCode, in_a_varCopy, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_varAssign, a_varCopy, a_varDecls) = fun_65(txt, ret_0, a_fname, a_varAssign, a_simCode, i_var_name, a_varCopy, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        (l_instDimsInit, a_varDecls, a_varInits) = lm_66(l_instDimsInit, i_instDims, a_simCode, a_varDecls, a_varInits);
        ...
        (txt, a_varInits, a_varAssign) = fun_67(txt, i_instDims, l_instDimsInit, a_varInits, a_simCode, i_var_name, l_assginEnd, a_fname, l_assginBegin, a_varAssign);
      then (txt, a_varInits, a_varAssign, a_varCopy, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_fn, in_a_var, in_a_ix, in_a_varDecls, in_a_varInits, in_a_varCopy, in_a_varAssign, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        l_fname = underscorePath(Tpl.emptyTxt, i_name);
        (txt, a_varInits, a_varAssign, a_varCopy, a_varDecls) = fun_68(txt, a_var, a_ix, a_varInits, l_fname, a_varAssign, a_simCode, a_varCopy, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_varInits)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varInits, a_varDecls) = daeExp(txt, i_exp, SimCode.contextFunction, a_varInits, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_varInits) = lm_74(txt, rest, a_simCode, a_varDecls, a_varInits);
      then (txt, a_varDecls, a_varInits);
  ...
  matchcontinue(in_txt, in_a_var_value, in_a_var_name, in_a_simCode, in_a_varDecls, in_a_i, in_a_outStruct, in_a_var, in_a_instDimsInit, in_a_varName, in_a_varInits)
    ...
    case ( txt,
      ...
      equation
        ...
        a_varInits = Tpl.writeText(a_varInits, l_defaultValue);
        l_var__name = fun_76(Tpl.emptyTxt, a_outStruct, a_simCode, a_var_name);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_instDims, in_a_i, in_a_outStruct, in_a_var, in_a_instDimsInit, in_a_varName, in_a_varDecls, in_a_varInits, in_a_simCode, in_a_var_name, in_a_var_value)
    ...
    case ( txt,
           ...
           a_var_value )
      equation
        (txt, a_varDecls, a_varInits) = fun_75(txt, a_var_value, a_varDecls, a_varInits, a_simCode, a_var_name);
      then (txt, a_varDecls, a_varInits);
    ...
    case ( txt,
           ...
           a_var_value )
      equation
        (txt, a_varDecls, a_varInits) = fun_77(txt, a_var_value, a_var_name, a_simCode, a_varDecls, a_i, a_outStruct, a_var, a_instDimsInit, a_varName, a_varInits);
      then (txt, a_varDecls, a_varInits);
  end matchcontinue;
end fun_78;
  ...
  matchcontinue(in_txt, in_a_var, in_a_outStruct, in_a_i, in_a_varDecls, in_a_varInits, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        l_initVar = fun_70(Tpl.emptyTxt, str_3);
        str_5 = Tpl.textString(l_typ);
        l_addRoot = fun_71(Tpl.emptyTxt, str_5, l_varName);
        a_varDecls = fun_72(a_varDecls, i_instDims, i_var_ty, l_addRoot, l_initVar, l_varName, l_typ);
        l_varName_1 = fun_73(Tpl.emptyTxt, a_outStruct, a_i, a_simCode, i_var_name);
        l_instDimsInit = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING("][")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_instDimsInit, a_varDecls, a_varInits) = lm_74(l_instDimsInit, i_instDims, a_simCode, a_varDecls, a_varInits);
        l_instDimsInit = Tpl.popIter(l_instDimsInit);
        (txt, a_varDecls, a_varInits) = fun_78(txt, i_instDims, a_i, a_outStruct, i_var, l_instDimsInit, l_varName_1, a_varDecls, a_varInits, a_simCode, i_var_name, i_var_value);
      then (txt, a_varDecls, a_varInits);
  ...
  matchcontinue(in_txt, in_a_var, in_a_varInit)
    ...
    case ( txt,
      ...
      equation
        ...
        l_typelist = lm_80(l_typelist, i_args);
        ...
        (txt, a_varInit) = fun_83(txt, i_tys, l_rettype, l_typelist, i_name, a_varInit);
      then (txt, a_varInit);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_var, in_a_outStruct, in_a_i, in_a_lhsVarName, in_a_varDecls, in_a_varInits, in_a_simCode)
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        (txt, a_varDecls, a_varInits) = fun_88(txt, i_value, a_lhsVarName, a_varDecls, a_varInits, a_i, a_outStruct, a_simCode, i_var_ty);
      then (txt, a_varDecls, a_varInits);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_var)
    ...
    case ( txt,
      ...
      equation
        txt = fun_95(txt, i_instDims, i_var_ty);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_var)
    ...
    case ( txt,
           SimCode.VARIABLE(instDims = i_instDims, ty = i_var_ty) )
      equation
        txt = fun_97(txt, i_instDims, i_var_ty);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_var)
    ...
    case ( txt,
           SimCode.VARIABLE(instDims = i_instDims, ty = i_var_ty) )
      equation
        txt = fun_99(txt, i_instDims, i_var_ty);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_101(txt, i_statementLst, a_simCode, a_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_modelInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.popBlock(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_116(txt, i_vars_boolAlgVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_117(txt, i_vars_boolParamVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(1));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_118(txt, i_vars_boolAliasVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        ...
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_121(txt, i_vars_stringAliasVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(1));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_122(txt, i_vars_constVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_123(txt, i_vars_intConstVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_124(txt, i_vars_boolConstVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_125(txt, i_vars_stringConstVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.popBlock(txt);
      then txt;
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING("][")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_130(txt, i_v_numArrayElement);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("])"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.nextIter(txt);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_131(out_txt, a_varsLst);
  out_txt := Tpl.popIter(out_txt);
end arrayConstruct1;
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = cref(txt, i_name);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = fun_149(txt, i_initialValue);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(")"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.nextIter(txt);
        txt = lm_150(txt, rest);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_150(out_txt, a_varsLst);
  out_txt := Tpl.popIter(out_txt);
end initVals;
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = cref(txt, i_name);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("="));
        txt = fun_153(txt, i_initialValue);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.nextIter(txt);
        txt = lm_154(txt, rest);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_154(out_txt, a_varsLst);
  out_txt := Tpl.popIter(out_txt);
end initVals1;
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_157(out_txt, a_varsLst);
  out_txt := Tpl.popIter(out_txt);
end arrayReindex1;
  ...
  matchcontinue(in_txt, in_a_modelInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt_0 = lm_162(txt_0, i_vars_algVars);
        ...
        txt_1 = lm_163(txt_1, i_vars_intAlgVars);
        ...
        txt_2 = lm_164(txt_2, i_vars_boolAlgVars);
        ...
        txt_3 = lm_165(txt_3, i_vars_aliasVars);
        ...
        txt_4 = lm_166(txt_4, i_vars_intAliasVars);
        ...
        txt_5 = lm_167(txt_5, i_vars_boolAliasVars);
        ...
        txt_6 = lm_168(txt_6, i_vars_stateVars);
        ...
        txt_7 = lm_169(txt_7, i_vars_derivativeVars);
        txt_7 = Tpl.popIter(txt_7);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(",")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = smf_170(txt, txt_0);
        txt = smf_171(txt, txt_1);
        txt = smf_172(txt, txt_2);
        txt = smf_173(txt, txt_3);
        txt = smf_174(txt, txt_4);
        txt = smf_175(txt, txt_5);
        txt = smf_176(txt, txt_6);
        txt = smf_177(txt, txt_7);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.popBlock(txt);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_modelInfo)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = fun_183(txt, i_varInfo_dimODE1stOrder);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("+"));
        txt = fun_184(txt, i_varInfo_dimODE2ndOrder);
        txt = Tpl.popBlock(txt);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_a_modelInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = cref(txt, i_name);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = lm_187(txt, rest, a_modelInfo);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_modelInfo)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(4));
        txt = lm_186(txt, i_vars_algVars);
        txt = Tpl.softNewLine(txt);
        txt = lm_187(txt, i_vars_intAlgVars, i_modelInfo);
        txt = Tpl.softNewLine(txt);
        txt = lm_188(txt, i_vars_boolAlgVars, i_modelInfo);
        txt = Tpl.softNewLine(txt);
        txt = lm_189(txt, i_vars_stateVars, i_modelInfo);
        txt = Tpl.softNewLine(txt);
        txt = lm_190(txt, i_vars_derivativeVars);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "\n",
                                    "\n"
  ...
  matchcontinue(in_txt, in_a_initialValue, in_a_sv_name, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_203(txt, str_3, a_simCode, a_sv_name);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_simCode)
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        txt = fun_204(txt, i_initialValue, i_sv_name, a_simCode);
        txt = Tpl.nextIter(txt);
        txt = lm_205(txt, rest, a_simCode);
      then txt;
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_205(out_txt, a_varsLst, a_simCode);
  out_txt := Tpl.popIter(out_txt);
end initValst;
  ...
  matchcontinue(in_txt, in_a_dimODE1stOrder, in_a_vi_dimODE1stOrder)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_208(txt, a_vi_dimODE1stOrder);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.popBlock(txt);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_it, in_a_vi_dimODE1stOrder)
    ...
    case ( txt,
           ...
           a_vi_dimODE1stOrder )
      equation
        txt = fun_209(txt, i_dimODE1stOrder, a_vi_dimODE1stOrder);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" "));
      then txt;
  ...
  matchcontinue(in_txt, in_a_dimODE2ndOrder, in_a_vi_dimODE2ndOrder)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_211(txt, a_vi_dimODE2ndOrder);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.popBlock(txt);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_it, in_a_vi_dimODE2ndOrder)
    ...
    case ( txt,
           ...
           a_vi_dimODE2ndOrder )
      equation
        txt = fun_212(txt, i_dimODE2ndOrder, a_vi_dimODE2ndOrder);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" "));
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(3));
        txt = smf_210(txt, i_modelInfo_varInfo, i_vi_dimODE1stOrder);
        txt = Tpl.softNewLine(txt);
        txt = smf_213(txt, i_modelInfo_varInfo, i_vi_dimODE2ndOrder);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.popBlock(txt);
      then txt;
...
public function contextArrayCref
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_216(txt, a_context, a_cr);
...
public function expTypeFlag
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_225(txt, a_flag, a_ty);
end expTypeFlag;
...
public function contextCref
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_237(txt, a_context, a_cr, a_simCode);
end contextCref;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_preExp) = lm_240(txt, rest, a_simCode, a_preExp);
      then (txt, a_preExp);
...
algorithm
  ...
  (l_eqPart, l_preExp) := lm_240(l_eqPart, a_initialEquations, a_simCode, l_preExp);
  ...
  matchcontinue(in_txt, in_a_eq, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        str_3 = Tpl.textString(txt_2);
        (txt, a_varDecls) = fun_247(txt, str_3, l_expPart, i_eqn_componentRef, l_preExp, a_varDecls);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("\")"));
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_251(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_eq, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_helpIf, a_varDecls, l_preExp) = lm_251(l_helpIf, i_conditions, a_simCode, a_varDecls, l_preExp, a_context);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_253(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  ...
  (l_reinit, l_varDecls) := lm_253(l_reinit, a_whenClauses, a_simCode, l_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_255(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_whenClauses, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        l_helpInits = Tpl.emptyTxt;
        l_helpIf = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING("")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_helpIf, a_varDecls, l_preExp) = lm_255(l_helpIf, i_conditions, a_simCode, a_varDecls, l_preExp, a_context);
        l_helpIf = Tpl.popIter(l_helpIf);
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(1));
        txt = Tpl.writeText(txt, l_preExp);
        txt = Tpl.softNewLine(txt);
...
public function helpvarvector1
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_256(txt, a_whenClauses, a_context, a_varDecls, a_simCode);
end helpvarvector1;
...
algorithm
  ...
  (l_reinit, l_varDecls) := lm_260(l_reinit, a_whenClauses, a_simCode, l_varDecls);
  l_reinit := Tpl.popIter(l_reinit);
  out_txt := Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
  out_txt := Tpl.writeText(out_txt, l_reinit);
  out_txt := Tpl.popBlock(out_txt);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("   "));
        txt = Tpl.popBlock(txt);
        (txt, a_varDecls, a_preExp) = lm_262(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_whenClauses, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        l_preExp = Tpl.emptyTxt;
        l_helpInits = Tpl.emptyTxt;
        (l_helpIf, a_varDecls, l_preExp) = lm_262(Tpl.emptyTxt, i_conditions, a_simCode, a_varDecls, l_preExp, a_context);
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(1));
        txt = Tpl.writeText(txt, l_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, l_helpIf);
...
public function resethelpvar1
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_263(txt, a_whenClauses, a_context, a_varDecls, a_simCode);
end resethelpvar1;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_tmpVar, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_tmpVar, a_preExp) = lm_270(txt, rest, a_simCode, a_tmpVar, a_preExp, a_context);
      then (txt, a_tmpVar, a_preExp);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_params, l_tmpVar, a_preExp) = lm_270(l_params, i_array, a_simCode, l_tmpVar, a_preExp, a_context);
  ...
  matchcontinue(in_txt, in_items, in_a_res, in_a_simCode, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
        txt = Tpl.nextIter(txt);
        txt = lm_273(txt, rest, a_res, a_simCode, a_context);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_275(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_inExp, in_a_simCode, in_a_preExp, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        l_expl = lm_273(l_expl, i_exp_array, l_res, a_simCode, a_context);
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_varDecls, a_preExp) = fun_274(txt, a_context, a_simCode, a_varDecls, a_preExp, i_subs, i_ecr, l_arrName);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        (l_expIndexes, a_varDecls, a_preExp) = lm_275(l_expIndexes, i_indexes, a_simCode, a_varDecls, a_preExp, a_context);
...
algorithm
  ...
  matchcontinue(in_txt, in_mArg, in_a_inExp, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        (txt, a_varDecls, a_preExp) = fun_272(txt, a_inExp, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        (txt, a_preExp, a_varDecls) = fun_276(txt, a_inExp, a_simCode, a_preExp, a_context, a_varDecls);
      then (txt, a_preExp, a_varDecls);
  end matchcontinue;
end fun_277;
...
algorithm
  ...
  (out_txt, out_a_preExp, out_a_varDecls) := fun_277(txt, str_1, a_inExp, a_context, a_preExp, a_varDecls, a_simCode);
end daeExpAsub;
  ...
  matchcontinue(in_txt, in_a_exp, in_a_subs, in_a_arrName, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_dimsValuesStr, a_varDecls, a_preExp) = lm_280(l_dimsValuesStr, a_subs, a_simCode, a_varDecls, a_preExp, a_context);
        l_dimsValuesStr = Tpl.popIter(l_dimsValuesStr);
        str_4 = Tpl.textString(l_arrayType);
        txt = fun_281(txt, str_4, i_ecr_componentRef, l_dimsValuesStr, a_arrName);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_283(txt, i_ty, a_preExp, i_exp, a_varDecls, l_expVar);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_exp, a_context, a_preExp, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_288(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_exp, a_context, a_preExp, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_290(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_exp, a_context, a_preExp, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_292(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_exp, a_context, a_preExp, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_294(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_296(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_context, in_a_argStr, in_a_funName, in_a_retType, in_a_retVar)
    ...
    case ( txt,
           ...
           a_retVar )
      equation
        txt = fun_302(txt, a_retVar, a_retType);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_attr_builtin, in_a_funName, in_a_context)
    ...
    case ( txt,
           ...
           a_context )
      equation
        txt = fun_304(txt, a_context, a_funName);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_exp, in_a_retVar)
    ...
    case ( txt,
           ...
           a_retVar )
      equation
        txt = fun_306(txt, i_attr_builtin, a_retVar);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_call, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        l_type = fun_285(Tpl.emptyTxt, i_attr_ty);
    ...
    case ( txt,
      ...
      equation
        ...
        l_cast = fun_286(Tpl.emptyTxt, i_arg_ty);
    ...
    case ( txt,
      ...
      equation
        ...
        (l_argStr, a_varDecls, a_preExp) = lm_288(l_argStr, i_expLst, a_simCode, a_varDecls, a_preExp, a_context);
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING(");"));
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_NEW_LINE());
        txt = fun_289(txt, i_attr_builtin, l_retType, l_retVar);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        l_argStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_argStr, a_varDecls, a_preExp) = lm_290(l_argStr, i_expLst, a_simCode, a_varDecls, a_preExp, a_context);
        l_argStr = Tpl.popIter(l_argStr);
        l_funName = underscorePath(Tpl.emptyTxt, i_path);
        l_retType = Tpl.writeText(Tpl.emptyTxt, l_funName);
        l_retType = Tpl.writeTok(l_retType, Tpl.ST_STRING("_rettype"));
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING(");"));
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_NEW_LINE());
        txt = fun_291(txt, i_attr_builtin, l_retType, l_retVar);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        l_argStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_argStr, a_varDecls, a_preExp) = lm_292(l_argStr, i_expLst, a_simCode, a_varDecls, a_preExp, a_context);
        l_argStr = Tpl.popIter(l_argStr);
        l_funName = underscorePath(Tpl.emptyTxt, i_path);
        l_retType = Tpl.writeText(Tpl.emptyTxt, l_funName);
        l_retType = Tpl.writeTok(l_retType, Tpl.ST_STRING("_rettype"));
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING(");"));
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_NEW_LINE());
        txt = fun_293(txt, i_attr_builtin, l_retType, l_retVar);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        l_argStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_argStr, a_varDecls, a_preExp) = lm_294(l_argStr, i_expLst, a_simCode, a_varDecls, a_preExp, a_context);
        l_argStr = Tpl.popIter(l_argStr);
        l_funName = underscorePath(Tpl.emptyTxt, i_path);
        l_retType = Tpl.writeText(Tpl.emptyTxt, l_funName);
        l_retType = Tpl.writeTok(l_retType, Tpl.ST_STRING("_rettype"));
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING(");"));
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_NEW_LINE());
        txt = fun_295(txt, i_attr_builtin, l_retType, l_retVar);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        (l_dimsExp, a_varDecls, a_preExp) = lm_296(l_dimsExp, i_dims, a_simCode, a_varDecls, a_preExp, a_context);
    ...
    case ( txt,
      ...
      equation
        ...
        (l_arrays__exp, a_varDecls, a_preExp) = lm_297(l_arrays__exp, i_arrays, a_simCode, a_varDecls, a_preExp, a_context);
    ...
    case ( txt,
      ...
      equation
        l_argStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_argStr, a_varDecls, a_preExp) = lm_298(l_argStr, i_expLst, a_simCode, a_varDecls, a_preExp, a_context);
        l_argStr = Tpl.popIter(l_argStr);
        l_funName = underscorePath(Tpl.emptyTxt, i_path);
        l_retType = Tpl.writeText(Tpl.emptyTxt, l_funName);
        l_retType = Tpl.writeTok(l_retType, Tpl.ST_STRING("RetType"));
        (l_retVar, a_varDecls) = fun_299(Tpl.emptyTxt, i_exp, a_varDecls, l_retType);
        a_preExp = fun_301(a_preExp, a_context, l_argStr, l_funName, l_retVar);
        a_preExp = fun_303(a_preExp, a_context, l_argStr, l_funName, l_retType, l_retVar);
        a_preExp = fun_305(a_preExp, i_attr_builtin, l_funName, a_context);
        txt = fun_307(txt, i_exp, l_retVar);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  out_txt := fun_312(out_txt, ret_4, l_msgVar);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_LINE(");\n"));
  out_txt := Tpl.popBlock(out_txt);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_317(txt, i_operator, l_e);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_319(txt, i_operator, l_e2, l_e1);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_it, in_a_preExp, in_a_varDecls, in_a_e2, in_a_e1)
    ...
    case ( txt,
           ...
           a_e1 )
      equation
        l_type = fun_321(Tpl.emptyTxt, i_ty, i_dims);
        l_type1 = fun_322(Tpl.emptyTxt, i_ty);
    ...
    case ( txt,
           ...
           a_e1 )
      equation
        l_type = fun_323(Tpl.emptyTxt, i_ty, i_dims);
        l_type1 = fun_324(Tpl.emptyTxt, i_ty);
        (l_var1, a_varDecls) = tempDecl1(Tpl.emptyTxt, Tpl.textString(l_type), Tpl.textString(a_e1), a_varDecls);
        a_preExp = Tpl.writeText(a_preExp, l_var1);
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING("=multiply_array<"));
        a_preExp = Tpl.writeText(a_preExp, l_type1);
    ...
    case ( txt,
           ...
           a_e1 )
      equation
        l_type = fun_325(Tpl.emptyTxt, i_ty);
        (l_var, a_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(l_type), a_varDecls);
...
algorithm
  ...
  (out_txt, out_a_preExp, out_a_varDecls) := fun_326(txt, a_it, out_a_preExp, out_a_varDecls, l_e2, l_e1);
end daeExpBinary;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        (l_e, a_preExp, a_varDecls) = daeExp(Tpl.emptyTxt, i_exp, a_context, a_preExp, a_varDecls, a_simCode);
        (txt, a_preExp) = fun_330(txt, i_operator, a_preExp, l_e);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        (txt, a_varDecls, a_preExp) = fun_332(txt, a_context, i_cr, i_t, a_simCode, a_varDecls, a_preExp, i_exp);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context, in_a_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_334(txt, rest, a_simCode, a_varDecls, a_preExp, a_context, a_cr);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_ty, in_a_cr, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_vars, a_varDecls, a_preExp) = lm_334(l_vars, i_var__lst, a_simCode, a_varDecls, a_preExp, a_context, a_cr);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_exp, a_context, a_preExp, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_336(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_mArg, in_a_simCode, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        l_dimsValuesStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING("][")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_dimsValuesStr, a_varDecls, a_preExp) = lm_336(l_dimsValuesStr, ret_7, a_simCode, a_varDecls, a_preExp, a_context);
        l_dimsValuesStr = Tpl.popIter(l_dimsValuesStr);
        str_8 = Tpl.textString(l_arrayType);
        txt = fun_337(txt, str_8, l_dimsValuesStr, l_arrName);
      then (txt, a_preExp, a_varDecls);
  end matchcontinue;
end fun_338;
  ...
  matchcontinue(in_txt, in_mArg, in_a_simCode, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_338(txt, ret_0, a_simCode, a_preExp, a_varDecls, a_ty, a_context, a_cr);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
           ...
           a_cr )
      equation
        l_cast = fun_339(Tpl.emptyTxt, a_ty);
  ...
  matchcontinue(in_txt, in_a_box, in_a_simCode, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_340(txt, ret_0, a_simCode, a_preExp, a_varDecls, a_ty, a_context, a_cr);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_ecr, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_341(txt, l_box, a_simCode, a_preExp, a_varDecls, i_ty, a_context, i_cr);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
           ...
           a_context )
      equation
        (txt, a_varDecls, a_preExp) = fun_343(txt, i_sub, a_simCode, a_varDecls, a_preExp, a_context);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_344(txt, rest, a_simCode, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  (l_idx__str, out_a_varDecls, out_a_preExp) := lm_344(l_idx__str, a_subs, a_simCode, a_varDecls, a_preExp, a_context);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_ecr, in_a_context, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls) = fun_346(txt, a_context, i_dims, a_varDecls, i_aty);
      then (txt, a_varDecls);
...
public function daeExpCrefRhsArrayBox
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_347(txt, a_ecr, a_context, a_varDecls);
  out_a_preExp := a_preExp;
...
algorithm
  ...
  matchcontinue(in_txt, in_it, in_a_simCode, in_a_inCref)
    ...
    case ( txt,
           ...
           a_inCref )
      equation
        txt = fun_350(txt, i_varKind, a_simCode, a_inCref);
      then txt;
...
algorithm
  ...
  out_txt := smf_351(txt, ret_0, a_simCode, a_inCref);
...
algorithm
  ...
  matchcontinue(in_txt, in_it, in_a_inCref)
    ...
    case ( txt,
           ...
           a_inCref )
      equation
        txt = fun_353(txt, i_index, a_inCref);
      then txt;
...
algorithm
  ret_0 := SimCode.cref2simvar(a_inCref, a_simCode);
  out_txt := smf_354(txt, ret_0, a_inCref);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_index, in_a_e2, in_a_e1, in_a_op)
    ...
    case ( txt,
           ...
           a_op )
      equation
        txt = fun_361(txt, a_op, a_e2, a_e1);
      then txt;
...
algorithm
  (l_e1, out_a_preExp, out_a_varDecls) := daeExp(Tpl.emptyTxt, a_exp1, a_context, a_preExp, a_varDecls, a_simCode);
  (l_e2, out_a_preExp, out_a_varDecls) := daeExp(Tpl.emptyTxt, a_exp2, a_context, out_a_preExp, out_a_varDecls, a_simCode);
  out_txt := fun_363(txt, a_index, l_e2, l_e1, a_op);
end daeExpRelation;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_369(txt, rest, a_simCode, a_varDecls, a_context);
      then (txt, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_eq, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_369(txt, i_statements, a_simCode, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_371(txt, rest, a_simCode, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_it, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_371(txt, i_statementLst, a_simCode, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
    ...
    case ( txt,
      ...
      equation
        ...
        (l_stmtStr, a_varDecls) = lm_372(l_stmtStr, i_statementLst, a_simCode, a_varDecls, a_context);
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_373(txt, i_statementLst, a_simCode, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_afterExp, in_a_context, in_a_retStruct)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_afterExp) = lm_376(txt, rest, a_simCode, a_varDecls, a_afterExp, a_context, a_retStruct);
      then (txt, a_varDecls, a_afterExp);
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        l_crefs = lm_375(l_crefs, i_expExpLst);
        ...
        (l_lhsCrefs, a_varDecls, l_afterExp) = lm_376(l_lhsCrefs, i_expExpLst, a_simCode, a_varDecls, l_afterExp, a_context, l_retStruct);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_stmt, a_context, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_380(txt, rest, a_simCode, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        l_stmtStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_stmtStr, a_varDecls) = lm_380(l_stmtStr, i_statementLst, a_simCode, a_varDecls, a_context);
        l_stmtStr = Tpl.popIter(l_stmtStr);
...
public function contextIteratorName
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_383(txt, a_context, a_name);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_stmt, a_context, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_386(txt, rest, a_simCode, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_when, in_a_simCode, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_386(txt, i_statementLst, a_simCode, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
...
algorithm
  ...
  matchcontinue(in_txt, in_a_context, in_a_when, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        (txt, a_varDecls) = fun_387(txt, a_when, a_simCode, a_varDecls, i_context);
      then (txt, a_varDecls);
...
public function algStmtWhen
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_388(txt, a_context, a_when, a_varDecls, a_simCode);
end algStmtWhen;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_391(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        l_elseCondStr = lm_390(l_elseCondStr, i_when_helpVarIndices);
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_391(txt, i_when_statementLst, a_simCode, a_varDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
  ...
  matchcontinue(in_txt, in_a_range, in_a_iterator, in_a_type, in_a_body, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_varDecls, l_preExp) = fun_394(txt, i_expOption, a_body, l_stopValue, l_startValue, l_iterName, a_type, a_simCode, a_varDecls, l_preExp, a_context);
      then (txt, a_varDecls);
...
public function algStmtForRange_impl
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_395(txt, a_range, a_iterator, a_type, a_body, a_context, a_varDecls, a_simCode);
  out_a_body := a_body;
  ...
  matchcontinue(in_txt, in_a_exp, in_a_rhsStr, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_397(txt, a_context, l_lhsStr, a_rhsStr, i_t);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_ecr, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_varDecls, a_preExp) = fun_400(txt, ret_0, i_ecr_componentRef, a_simCode, a_varDecls, a_preExp, a_context, i_ecr);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_it, a_context, a_varDecls, a_simCode);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_402(txt, rest, a_simCode, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_it, in_a_context, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_402(txt, i_statementLst, a_simCode, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
...
public function elseExpr
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_404(txt, a_it, a_context, a_varDecls, a_simCode);
  out_a_preExp := a_preExp;
end elseExpr;
...
public function expType
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_406(txt, a_isArray, a_ty);
end expType;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_411(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_411(out_txt, a_zeroCrossings, a_simCode, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
...
public function zeroCrossingTpl2
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_413(txt, a_relation, a_varDecls, a_simCode);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_416(out_txt, a_sampleConditions, a_simCode, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
end timeEventcondition;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_422(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  l_varDecls := Tpl.emptyTxt;
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, l_varDecls) := lm_422(out_txt, a_sampleConditions, a_simCode, l_varDecls);
  out_txt := Tpl.popIter(out_txt);
end resetTimeEvent;
...
public function resetTimeEvent1
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_424(txt, a_relation, a_varDecls, a_simCode);
end resetTimeEvent1;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_428(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  l_varDecls := Tpl.emptyTxt;
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, l_varDecls) := lm_428(out_txt, a_sampleConditions, a_simCode, l_varDecls);
  out_txt := Tpl.popIter(out_txt);
end handleEvent1;
...
public function handleEvent2
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_430(txt, a_relation, a_varDecls, a_simCode);
end handleEvent2;
...
algorithm
  ...
  out_txt := fun_432(txt, a_simCode, l_zeroCrossingsCode, l_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_434(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_434(out_txt, a_zeroCrossings, a_simCode, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
...
public function handleSystemEvents2
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_436(txt, a_relation, a_varDecls, a_simCode);
...
algorithm
  ...
  out_txt := fun_439(txt, a_simCode, l_zeroCrossingsCode, l_varDecls);
end giveZeroFunc1;
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_441(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varDecls) := lm_441(out_txt, a_zeroCrossings, a_simCode, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
end giveZeroFunc2;
...
public function giveZeroFunc3
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_443(txt, a_relation, a_index1, a_varDecls, a_simCode);
end giveZeroFunc3;
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_445(out_txt, a_zeroCrossings, a_simCode);
  out_txt := Tpl.popIter(out_txt);
...
public function conditionvarZero1
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_447(txt, a_relation);
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_449(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  l_varDecls := Tpl.emptyTxt;
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, l_varDecls) := lm_449(out_txt, a_sampleConditions, a_simCode, l_varDecls);
  out_txt := Tpl.popIter(out_txt);
...
public function conditionvarSample1
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_451(txt, a_relation, a_varDecls, a_simCode);
...
algorithm
  ...
  l_changediscreteVars := lm_475(l_changediscreteVars, a_discreteModelVars);
  l_changediscreteVars := Tpl.popIter(l_changediscreteVars);
  out_txt := fun_476(txt, a_simCode, l_changediscreteVars);
...
algorithm
  ...
  (l_continous, l_varDecls) := lm_478(l_continous, a_continousEquations, a_simCode, l_varDecls);
  ...
  (l_paraEquations, l_varDecls) := lm_479(l_paraEquations, a_parameterEquations, a_simCode, l_varDecls);
  ...
  (l_discrete, l_varDecls) := lm_480(l_discrete, a_discreteEquations, a_simCode, l_varDecls);
  l_discrete := Tpl.popIter(l_discrete);
  l_reinit := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (l_reinit, l_varDecls) := lm_481(l_reinit, a_whenClauses, a_simCode, l_varDecls);
  l_reinit := Tpl.popIter(l_reinit);
  out_txt := fun_482(txt, a_simCode, l_reinit, l_discrete, l_continous, l_paraEquations, l_varDecls);
end update;
  ...
  matchcontinue(in_txt, in_items, in_a_helpInits, in_a_simCode, in_a_varDecls, in_a_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("\")"));
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_484(txt, rest, a_helpInits, a_simCode, a_varDecls, a_preExp);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_whenClauses, in_a_varDecls, in_a_int, in_a_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        l_helpInits = Tpl.emptyTxt;
        l_helpIf = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING("||")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_helpIf, a_varDecls, l_preExp) = lm_484(l_helpIf, i_conditions, l_helpInits, a_simCode, a_varDecls, l_preExp);
        l_helpIf = Tpl.popIter(l_helpIf);
        (l_ifthen, a_varDecls) = functionWhenReinitStatementThen(Tpl.emptyTxt, i_reinits, a_varDecls, a_simCode);
        txt = fun_485(txt, i_reinits, l_ifthen, l_helpIf, l_helpInits, l_preExp, a_int);
      then (txt, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_simCode, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls) = fun_487(txt, i_reinit, a_simCode, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_488(txt, rest, a_simCode, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  ...
  (l_body, out_a_varDecls) := lm_488(l_body, a_reinits, a_simCode, a_varDecls);
