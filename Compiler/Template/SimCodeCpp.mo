...
algorithm
  ...
  matchcontinue(in_txt, in_a_exp, in_a_retType, in_a_retVar)
    ...
    case ( txt,
           ...
           a_retVar )
      equation
        txt = fun_198(txt, i_builtin, a_retType, a_retVar);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_call, in_a_context, in_a_preExp, in_a_varDecls, in_a_simCode)
    ...
    case ( txt,
           ...
           a_simCode )
      equation
        l_type = fun_184(Tpl.emptyTxt, i_ty);
    ...
    case ( txt,
      ...
      equation
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING(");"));
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_NEW_LINE());
        txt = fun_188(txt, i_builtin, l_retType, l_retVar);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        a_preExp = fun_194(a_preExp, i_builtin, l_funName, a_context);
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING(");"));
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_NEW_LINE());
        a_preExp = fun_197(a_preExp, i_builtin, l_funName, a_context);
