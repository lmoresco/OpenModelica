  ...
  matchcontinue(in_txt, in_a_modifier)
    ...
    case ( txt,
      ...
      equation
        ...
        l_prefix__str = fun_108(Tpl.emptyTxt, i_subModLst);
        l_submod__str = fun_110(Tpl.emptyTxt, i_subModLst, l_prefix__str);
  ...
  matchcontinue(in_txt, in_a_modifier)
    ...
    case ( txt,
      ...
      equation
        ...
        l_el__str = lm_113(l_el__str, i_elementLst);
