  ...
  matchcontinue(in_txt, in_a_import)
    ...
    case ( txt,
      ...
      equation
        ...
        l_import__str = fun_24(Tpl.emptyTxt, i_imp);
  ...
  matchcontinue(in_txt, in_a_classDef)
    ...
    case ( txt,
      ...
      equation
        ...
        l_cdef__str = Tpl.popBlock(l_cdef__str);
        l_cmt__str = fun_30(Tpl.emptyTxt, l_cdef__str, i_comment);
    ...
    case ( txt,
      ...
      equation
        l_enum__str = fun_32(Tpl.emptyTxt, i_enumLst);
        l_cmt__str = dumpCommentOpt(Tpl.emptyTxt, i_comment);
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_33(txt, i_derivedVariables);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(")"));
        txt = Tpl.writeText(txt, l_cmt__str);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_classDef, in_a_cdefStr, in_a_name)
    ...
    case ( txt,
           ...
           a_name )
      equation
        txt = fun_36(txt, a_cdefStr, a_name);
      then txt;
  end matchcontinue;
end dumpClassFooter;
  ...
  matchcontinue(in_txt, in_a_component)
    ...
    case ( txt,
      ...
      equation
        ...
        l_type__str = AbsynDumpTpl.dumpTypeSpec(Tpl.emptyTxt, i_typeSpec);
        l_mod__str = dumpModifier(Tpl.emptyTxt, i_modifications);
        l_cond__str = fun_39(Tpl.emptyTxt, i_condition);
        l_cmt__str = dumpCommentOpt(Tpl.emptyTxt, i_comment);
  ...
  matchcontinue(in_txt, in_a_defineUnit)
    ...
    case ( txt,
      ...
      equation
        ...
        l_exp__str = fun_41(Tpl.emptyTxt, i_exp);
        l_weight__str = fun_42(Tpl.emptyTxt, i_weight);
        l_args__str = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        l_args__str = smf_43(l_args__str, l_exp__str);
        l_args__str = smf_44(l_args__str, l_weight__str);
        l_args__str = Tpl.popIter(l_args__str);
        l_pb = fun_45(Tpl.emptyTxt, l_args__str);
        l_pe = fun_46(Tpl.emptyTxt, l_args__str);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_equation)
    ...
    case ( txt,
      ...
      equation
        l_func__str = AbsynDumpTpl.dumpCref(Tpl.emptyTxt, i_functionName);
        l_args__str = AbsynDumpTpl.dumpFunctionArgs(Tpl.emptyTxt, i_functionArgs);
        l_cmt__str = dumpCommentOpt(Tpl.emptyTxt, i_comment);
        txt = Tpl.writeText(txt, l_func__str);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.writeText(txt, l_args__str);
  ...
  matchcontinue(in_txt, in_a_ifequation)
    ...
    case ( txt,
      ...
      equation
        ...
        l_if__branch__str = lm_53(l_if__branch__str, i_if__branch);
        ...
        l_else__str = fun_55(Tpl.emptyTxt, i_elseBranch);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if "));
  ...
  matchcontinue(in_txt, in_a_branches, in_a_rest__conds, in_a_cond)
    ...
    case ( txt,
      ...
      equation
        ...
        l_branch__str = lm_57(l_branch__str, i_branch);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_condition, in_a_branches)
    ...
    case ( txt,
           ...
           a_branches )
      equation
        txt = fun_58(txt, a_branches, i_rest__conds, i_cond);
      then txt;
  ...
  matchcontinue(in_txt, in_a_for__equation)
    ...
    case ( txt,
      ...
      equation
        ...
        l_eq__str = lm_60(l_eq__str, i_eEquationLst);
    ...
    case ( txt,
      ...
      equation
        l_eq__str = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        l_eq__str = lm_61(l_eq__str, i_eEquationLst);
        l_eq__str = Tpl.popIter(l_eq__str);
        l_cmt__str = dumpCommentOpt(Tpl.emptyTxt, i_comment);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("for "));
        txt = Tpl.writeStr(txt, i_index);
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
      ...
      equation
        ...
        l_else__body__str = lm_64(l_else__body__str, i_else__body);
  ...
  matchcontinue(in_txt, in_a_when__equation)
    ...
    case ( txt,
      ...
      equation
        ...
        l_body__str = lm_63(l_body__str, i_eEquationLst);
        ...
        l_else__str = lm_65(l_else__str, i_elseBranches);
...
algorithm
  ...
  out_txt := lm_70(out_txt, a_statements);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_statement)
    ...
    case ( txt,
      ...
      equation
        l_func__str = AbsynDumpTpl.dumpCref(Tpl.emptyTxt, i_functionCall);
        l_args__str = AbsynDumpTpl.dumpFunctionArgs(Tpl.emptyTxt, i_functionArgs);
        l_cmt__str = dumpCommentOpt(Tpl.emptyTxt, i_comment);
        txt = Tpl.writeText(txt, l_func__str);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_74(out_txt, a_else__if);
  out_txt := Tpl.popIter(out_txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
           i_i :: rest )
      equation
        txt = AbsynDumpTpl.dumpForIterator(txt, i_i);
        txt = Tpl.nextIter(txt);
        txt = lm_76(txt, rest);
      then txt;
  ...
  matchcontinue(in_txt, in_a_for__statement)
    ...
    case ( txt,
      ...
      equation
        ...
        l_iter__str = lm_76(l_iter__str, i_iterators);
  ...
  matchcontinue(in_txt, in_a_when__statement)
    ...
    case ( txt,
      ...
      equation
        ...
        l_elsewhen__str = lm_79(l_elsewhen__str, i_elsewhens);
  ...
  matchcontinue(in_txt, in_a_modifier)
    ...
    case ( txt,
      ...
      equation
        ...
        l_submod__str = fun_95(Tpl.emptyTxt, i_subModLst);
  ...
  matchcontinue(in_txt, in_a_submod)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = AbsynDumpTpl.dumpSubscripts(txt, i_subscriptLst);
...
algorithm
  ...
  out_txt := fun_110(txt, ret_0, a_annotation);
end dumpAnnotation;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_externalDecl)
    ...
    case ( txt,
      ...
      equation
        l_func__name__str = fun_115(Tpl.emptyTxt, i_funcName);
        ...
        l_func__args__str = lm_116(l_func__args__str, i_args);
        l_func__args__str = Tpl.popIter(l_func__args__str);
        l_func__str = fun_117(Tpl.emptyTxt, l_func__name__str, l_func__args__str);
        l_lang__str = fun_118(Tpl.emptyTxt, i_lang);
        l_output__str = fun_119(Tpl.emptyTxt, i_output__);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_comment)
    ...
    case ( txt,
      ...
      equation
        l_annl__str = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        l_annl__str = lm_122(l_annl__str, i_annotations);
        l_annl__str = Tpl.popIter(l_annl__str);
...
algorithm
  ret_0 := Config.showAnnotations();
  out_txt := fun_124(txt, ret_0, a_comment);
end dumpComment;
