...
*/
 ...
 constant String leyend = " Generated by OMCC v0.9.3 (OpenModelica Compiler- Compiler) Copyright 2011 Open Souce Modelica Consorsium (OSMC) ";
 ...
 function buildParserCode
  ...
  algorithm
    ...
    caseAction := "";
     ...
     while (Util.isListEmpty(types)==false) loop
       typeTok::types := types;
       ...
       if (Util.isListEmpty(types)==false) then
