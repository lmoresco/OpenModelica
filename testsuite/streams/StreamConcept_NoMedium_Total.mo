...
//   parameter Real valve_fixeddensity1.m_flow_small(quantity = "MassFlowRate", unit = "kg/s") = valve_fixeddensity1.m_start / 100.0 "Small mass flow rate for regularization of zero flow";
...
//   input Real watersink_ph_StreamConcept.p_in;
...
//   parameter Real ramp2.duration(quantity = "Time", unit = "s", min = 1e-060, start = 2.0) = 30.0 "Durations of ramp";
...
//   output Real ramp3.y "Connector of Real output signal";
//   parameter Real ramp3.height = 0.0 "Height of ramps";
//   parameter Real ramp3.duration(quantity = "Time", unit = "s", min = 1e-060, start = 2.0) = 300.0 "Durations of ramp";
...
//   input Real watersink_ph_StreamConcept1.p_in;
//   output Real InStreamEnthalpy.h_out(quantity = "SpecificEnergy", unit = "J/kg") "Specific enthalpy in port medium";
...
//   valve_fixeddensity1.port_b.h_outflow = (max(-watersink_ph_StreamConcept1.port.m_flow,1e-015) * watersink_ph_StreamConcept1.port.h_outflow + max(-InStreamEnthalpy.port.m_flow,1e-015) * InStreamEnthalpy.port.h_outflow) / (max(-watersink_ph_StreamConcept1.port.m_flow,1e-015) + max(-InStreamEnthalpy.port.m_flow,1e-015));
...
//   valve_fixeddensity1.h = valve_fixeddensity1.fromleft * (max(-watersink_ph_StreamConcept1.port.m_flow,1e-015) * watersink_ph_StreamConcept1.port.h_outflow + max(-InStreamEnthalpy.port.m_flow,1e-015) * InStreamEnthalpy.port.h_outflow) / (max(-watersink_ph_StreamConcept1.port.m_flow,1e-015) + max(-InStreamEnthalpy.port.m_flow,1e-015)) + (1.0 - valve_fixeddensity1.fromleft) * watersink_ph_StreamConcept.port.h_outflow;
...
//   InStreamEnthalpy.h_out = (max(-valve_fixeddensity1.port_a.m_flow,1e-015) * valve_fixeddensity1.port_a.h_outflow + max(-watersink_ph_StreamConcept1.port.m_flow,1e-015) * watersink_ph_StreamConcept1.port.h_outflow) / (max(-valve_fixeddensity1.port_a.m_flow,1e-015) + max(-watersink_ph_StreamConcept1.port.m_flow,1e-015));
