...
//   parameter Real valve_fixeddensity1.diameter(quantity = "Length", unit = "m") = valve_fixeddensity1.d "actual diameter";
//   parameter Real valve_fixeddensity1.Y_nom = valve_fixeddensity1.Y0 "Valve opening";
//   parameter Real valve_fixeddensity1.A(quantity = "Area", unit = "m2") = 0.785398163397448 * valve_fixeddensity1.diameter ^ 2.0 "inner cross sectional area";
...
//   else
//   valve_fixeddensity1.fromleft = 0.5 * (1.0 - 0.5 * (valve_fixeddensity1.m_flow * ((valve_fixeddensity1.m_flow / valve_fixeddensity1.m_flow_small) ^ 2.0 - 3.0) / valve_fixeddensity1.m_flow_small));
//   end if;
