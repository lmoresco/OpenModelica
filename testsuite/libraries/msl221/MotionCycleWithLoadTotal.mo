...
</html>"), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(points={{-60,-90},{20,-90}}, color={0,0,0}),Polygon(points={{50,-90},{20,-80},{20,-100},{50,-90}}, fillPattern=FillPattern.Solid, lineColor={128,128,128}, fillColor={128,128,128}),Text(extent={{0,110},{0,50}}, fillColor={0,0,255}, textString="%name"),Line(points={{-86,0},{-60,0},{-44,-30},{-16,30},{14,-30},{44,30},{60,0},{84,0}}, color={0,0,0})}), Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(points={{-100,0},{-100,65}}, color={128,128,128}),Line(points={{100,0},{100,65}}, color={128,128,128}),Line(points={{-100,60},{100,60}}, color={128,128,128}),Polygon(points={{90,63},{100,60},{90,57},{90,63}}, fillPattern=FillPattern.Solid, lineColor={128,128,128}, fillColor={128,128,128}),Text(extent={{-22,62},{18,87}}, textString="s_rel", fillColor={0,0,255}),Line(points={{-86,0},{-60,0},{-44,-30},{-16,30},{14,-30},{44,30},{60,0},{84,0}}, color={0,0,0})}));
...
<p>
        ...
        model PulseVoltage "Pulse voltage source"
          ...
          annotation(Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(points={{-70,-70},{-40,-70},{-40,70},{0,70},{0,-70},{40,-70},{40,70},{80,70}}, color={192,192,192})}), Documentation(revisions="<html>
<ul>
<li><i>  </i>
       </li>
<li><i> 1998   </i>
...
</html>"), Icon(coordinateSystem(extent={{-100,-100},{100,100}})), Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{-80,90},{-88,68},{-72,68},{-80,90}}),Line(visible=true, points={{-80,68},{-80,-80}}, color={192,192,192}),Line(visible=true, points={{-90,-70},{82,-70}}, color={192,192,192}),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{90,-70},{68,-62},{68,-78},{90,-70}}),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{-34,1},{-37,-12},{-30,-12},{-34,1}}),Line(visible=true, points={{-34,-1},{-34,-70}}, color={192,192,192}),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{-33,-70},{-36,-57},{-30,-57},{-33,-70},{-33,-70}}),Text(visible=true, lineColor={0,0,255}, fillColor={160,160,160}, extent={{-78,-36},{-35,-24}}, textString="offset"),Text(visible=true, lineColor={0,0,255}, fillColor={160,160,160}, extent={{-31,-87},{15,-69}}, textString="startTime"),Text(visible=true, lineColor={0,0,255}, fillColor={160,160,160}, extent={{70,-100},{94,-80}}, textString="time"),Line(visible=true, points={{-10,0},{-10,-70}}, color={192,192,192}, pattern=LinePattern.Dot),Line(visible=true, points={{-80,0},{-21,0},{-21,50},{21,50},{21,0},{41,0},{41,50},{79.72,50}}, thickness=0.5),Line(visible=true, points={{-19,88},{-19,49}}, color={192,192,192}, pattern=LinePattern.Dot),Line(visible=true, points={{21,74},{21,50}}, color={160,160,160}, pattern=LinePattern.Dot),Line(visible=true, points={{41,88},{41,50}}, color={192,192,192}, pattern=LinePattern.Dot),Line(visible=true, points={{-19,83},{42,83}}, color={192,192,192}),Line(visible=true, points={{-19,69},{21,69}}, color={192,192,192}),Text(visible=true, lineColor={0,0,255}, fillColor={160,160,160}, extent={{-9,85},{37,97}}, textString="period"),Text(visible=true, lineColor={0,0,255}, fillColor={160,160,160}, extent={{-18,69},{21,81}}, textString="width"),Line(visible=true, points={{-52,50},{-19,50}}, color={192,192,192}, pattern=LinePattern.Dot),Line(visible=true, points={{-34,50},{-34,1}}, color={192,192,192}),Text(visible=true, lineColor={0,0,255}, fillColor={160,160,160}, extent={{-78,20},{-37,34}}, textString="V"),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{-34,49},{-37,36},{-30,36},{-34,49}}),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{-34,1},{-37,14},{-31,14},{-34,1},{-34,1}}),Line(visible=true, points={{79.94,50.17},{79.94,8.882e-16},{90,8.882e-16}}, thickness=0.5),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{-19,69},{-10,71},{-10,67},{-19,69}}),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{21,69},{13,71},{13,67},{21,69}}),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{-19,83},{-10,85},{-10,81},{-19,83}}),Polygon(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, points={{41,83},{33,85},{33,81},{41,83}}),Text(visible=true, lineColor={0,0,255}, fillColor={160,160,160}, extent={{-78,89},{-24,103}}, textString="v = p.v - n.v")}));
        end PulseVoltage;
      end Sources;
...
Models of solenoid actuators based on magnetic networks are very useful for both coarse design of magnetic actuators itself (e.g. main dimensions, force-stroke charactersitics, dynamic behavior) and for system simulation together with neighboring subsystems, e.g. mechanical loads or excitation and control circuits.
  ...
  package Examples "Exemplary usage of solenoid models"
    extends Modelica.Icons.Library;
    model MotionCycleWithLoad "Pull-in and push-out stroke of a voltage-fed solenoid with mechanical load"
      annotation(Diagram, experiment(StopTime=0.1, Tolerance=1e-08), Documentation(info="<html>
<br>
<p>
...
<ul>
<li>LoadMass.s(start = 3e-3) m,</li>
<li>LoadMass.m = 0.01 kg,</li>
<li>ReturnSpring.c = 1000 N/m.</li>
</ul>
</p>
<p>
Plot versus time:
...
<li>LoadMass.s</li>
      ...
      Modelica.Electrical.Analog.Basic.Ground Ground annotation(extent=[-50,-30;-30,-10]);
      Solenoid.STA_195205_129 STA_195205_129(x_arm(start=0.003), x_max=0.003) annotation(extent=[-10,0;10,20]);
      Modelica.Electrical.Analog.Sources.PulseVoltage U_pulse(V=13.2, width=5) annotation(extent=[-50,0;-30,20], rotation=270);
      Modelica.Mechanics.Translational.Spring ReturnSpring(c=1000, s_rel0=0) annotation(extent=[30,0;50,20]);
      Modelica.Mechanics.Translational.Fixed FrameWithSpringPreload(s0=0.004) annotation(extent=[40,-20;60,0]);
      Modelica.Mechanics.Translational.SlidingMass LoadMass(m=0.01, s(start=0.003)) "Mechanical Load to be moved" annotation(extent=[30,30;50,50]);

    equation 
      connect(U_pulse.p,STA_195205_129.pin_p) annotation(points=[-40,20;-20,20;-20,16;-10,16], style(color=3, rgbcolor={0,0,255}));
      connect(STA_195205_129.pin_n,U_pulse.n) annotation(points=[-10,4;-20,4;-20,0;-40,0], style(color=3, rgbcolor={0,0,255}));
      connect(Ground.p,U_pulse.n) annotation(points=[-40,-10;-40,0], style(color=3, rgbcolor={0,0,255}));
      connect(STA_195205_129.ArmatureFlange,ReturnSpring.flange_a) annotation(points=[10,10;30,10], style(color=58, rgbcolor={0,127,0}));
      connect(ReturnSpring.flange_b,FrameWithSpringPreload.flange_b) annotation(points=[50,10;50,-10], style(color=58, rgbcolor={0,127,0}));
      connect(LoadMass.flange_a,ReturnSpring.flange_a) annotation(points=[30,40;30,10], style(color=58, rgbcolor={0,127,0}));
    end MotionCycleWithLoad;
  end Examples;
end Magnetic;

model Magnetic_Examples_MotionCycleWithLoad
  extends Magnetic.Examples.MotionCycleWithLoad;
end Magnetic_Examples_MotionCycleWithLoad;