...
according to the provided description in the models.
    ...
    encapsulated model Pendulum
      ...
      annotation(experiment(StopTime=1.6, Interval=0.01), Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Diagram(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})));
      Parts.InertialSystem inertial annotation(Placement(visible=true, transformation(origin={-40.0,0.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      Parts.BoxBody boxBody(r={L,0,0}) annotation(Placement(visible=true, transformation(origin={40.0,0.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      Joints.Revolute revolute(n={0,0,1}) annotation(Placement(visible=true, transformation(origin={-0.0,0.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      Rotational.Damper damper(d=d) annotation(Placement(visible=true, transformation(origin={-0.0,40.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
    equation 
      connect(inertial.frame_b,revolute.frame_a) annotation(Line(visible=true, origin={50.0,-30.0}, points={{-79.5,30.0},{-60.5,30.0}}, color={0,0,255}));
      connect(revolute.frame_b,boxBody.frame_a) annotation(Line(visible=true, origin={50.0,-30.0}, points={{-39.5,30.0},{-20.5,30.0}}, color={0,0,255}));
      connect(damper.flange_b,revolute.axis) annotation(Line(visible=true, origin={50.0,-30.0}, points={{-40.0,70.0},{-40.0,50.0},{-50.0,50.0},{-50.0,37.0}}, color={0,0,255}));
      connect(damper.flange_a,revolute.bearing) annotation(Line(visible=true, origin={50.0,-30.0}, points={{-60.0,70.0},{-60.0,50.0},{-56.0,50.0},{-56.0,37.0}}, color={0,0,255}));
    end Pendulum;
...
model MultiBody_Examples_Pendulum
  extends MultiBody.Examples.Pendulum;
end MultiBody_Examples_Pendulum;
