...
</html>", revisions=""), experiment(StopTime=1, Interval=0.01), Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Diagram(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})));
        Parts.InertialSystem inertial annotation(Placement(visible=true, transformation(origin={-90.0,-70.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Joints.Revolute j1(n={1,0,0}, qd(start=20), startValueFixed=true) annotation(Placement(visible=true, transformation(origin={-44.0,-30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Joints.Prismatic j2(n={1,0,0}) annotation(Placement(visible=true, transformation(origin={20.0,-70.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.CylinderBody b1(r={0,0.5,0.1}, Radius=0.05) annotation(Placement(visible=true, transformation(origin={-30.0,0.0}, extent={{10.0,10.0},{-10.0,-10.0}}, rotation=-90)));
        Parts.CylinderBody b2(r={0,0.2,0}, Radius=0.05) annotation(Placement(visible=true, transformation(origin={50.0,-50.0}, extent={{10.0,10.0},{-10.0,-10.0}}, rotation=-90)));
        Parts.BoxBody b0(r={1,0,0}, Width=0.01, Height=0.01, Material={0,0,1,0.5}) annotation(Placement(visible=true, transformation(origin={-10.0,-70.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        CutJoints.Spherical sphereC annotation(Placement(visible=true, transformation(origin={-10.0,30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.CylinderBody b3(r={-1,0.3,0.1}, Radius=0.05, Material={0,1,0,0.5}) annotation(Placement(visible=true, transformation(origin={30.0,30.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=0)));
        Joints.Revolute rev(n={0,1,0}) annotation(Placement(visible=true, transformation(origin={50.0,-22.0}, extent={{10.0,10.0},{-10.0,-10.0}}, rotation=-90)));
        Joints.Revolute rev1 annotation(Placement(visible=true, transformation(origin={70.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      equation 
        connect(b1.frame_b,sphereC.frame_a) annotation(Line(visible=true, points={{-30.0,10.5},{-30.0,30.0},{-20.5,30.0}}, color={0,0,255}));
        connect(j1.frame_b,b1.frame_a) annotation(Line(visible=true, points={{-33.5,-30.0},{-30.0,-30.0},{-30.0,-10.5}}, color={0,0,255}));
        connect(j2.frame_b,b2.frame_a) annotation(Line(visible=true, points={{30.5,-70.0},{50.0,-70.0},{50.0,-60.5}}, color={0,0,255}));
        connect(rev.frame_a,b2.frame_b) annotation(Line(visible=true, points={{50.0,-32.5},{50.0,-39.5}}, color={0,0,255}));
        connect(rev.frame_b,rev1.frame_a) annotation(Line(visible=true, points={{50.0,-11.5},{50.0,10.0},{59.5,10.0}}, color={0,0,255}));
        connect(inertial.frame_b,j1.frame_a) annotation(Line(visible=true, points={{-79.5,-70.0},{-66.0,-70.0},{-66.0,-30.0},{-54.5,-30.0}}, color={0,0,255}));
        connect(rev1.frame_b,b3.frame_a) annotation(Line(visible=true, points={{80.5,10.0},{90.0,10.0},{90.0,30.0},{40.5,30.0}}, color={0,0,255}));
        connect(b3.frame_b,sphereC.frame_b) annotation(Line(visible=true, points={{19.5,30.0},{0.5,30.0}}, color={0,0,255}));
        connect(b0.frame_b,j2.frame_a) annotation(Line(visible=true, points={{0.5,-70.0},{9.5,-70.0}}, color={0,0,255}));
        connect(inertial.frame_b,b0.frame_a) annotation(Line(visible=true, points={{-79.5,-70.0},{-20.5,-70.0}}, color={0,0,255}));
        j1q=j1.q;
        j2q=j2.q;
        j1qd=j1.qd;
        j2qd=j2.qd;
...
model MultiBody_Examples_Loops_Fourbar2
  extends MultiBody.Examples.Loops.Fourbar2;
end MultiBody_Examples_Loops_Fourbar2;
