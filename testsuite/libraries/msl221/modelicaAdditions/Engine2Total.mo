...
This package contains multibody models with kinematic loops
      ...
      encapsulated model Engine2
        ...
        annotation(Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Diagram(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Documentation(info="", revisions=""));
        CutJoints.Spherical spherical annotation(Placement(visible=true, transformation(origin={10.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.ShapeBody connectingRod(r={-L,0,0}, rCM={-L/2,0,0}, m=0.5, I33=0.0018, Width=0.02, Height=0.01) annotation(Placement(visible=true, transformation(origin={62.0,10.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=0)));
        Joints.Universal univ(nx={0,0,1}, ny={0,1,0}) annotation(Placement(visible=true, transformation(origin={80.0,-18.0}, extent={{-10.0,10.0},{10.0,-10.0}}, rotation=90)));
...
"), experiment(StopTime=0.2, Interval=0.002, Tolerance=1e-08), Commands(file="Engine2.mos" "Simulate and plot x, V"));
      equation 
        connect(cyl.frame_b,univ.frame_a) annotation(Line(visible=true, points={{60.5,-70.0},{68.0,-70.0},{68.0,-40.0},{80.0,-40.0},{80.0,-28.5}}, color={0,0,255}));
        connect(univ.frame_b,connectingRod.frame_a) annotation(Line(visible=true, points={{80.0,-7.5},{80.0,10.0},{72.5,10.0}}, color={0,0,255}));
        connect(spherical.frame_b,connectingRod.frame_b) annotation(Line(visible=true, points={{20.5,10.0},{51.5,10.0}}, color={0,0,255}));
        connect(crank.frame_b,spherical.frame_a) annotation(Line(visible=true, points={{-17.5,10.0},{-0.5,10.0}}, color={0,0,255}));
      end Engine2;
...
", revisions=""), Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Rectangle(visible=true, fillColor={192,192,192}, fillPattern=FillPattern.HorizontalCylinder, extent={{-90.0,-50.0},{40.0,50.0}}),Ellipse(visible=true, lineColor={192,192,192}, fillColor={192,192,192}, fillPattern=FillPattern.Solid, extent={{90.0,50.0},{-10.0,-50.0}}),Text(visible=true, lineColor={0,0,255}, fillPattern=FillPattern.Solid, extent={{-100.0,-130.0},{100.0,-70.0}}, textString="%name", fontName="Arial")}), Diagram(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})));
      Revolute revolute1(n=nx, q0=qx0, startValueFixed=startValueFixed) annotation(Placement(visible=true, transformation(origin={-36.5,0.0}, extent={{-25.5,-25.0},{25.5,25.0}}, rotation=0)));
      MultiBody.Joints.Revolute revolute2(n=ny, q0=qy0, startValueFixed=startValueFixed) annotation(Placement(visible=true, transformation(origin={35.0,45.0}, extent={{-25.0,25.0},{25.0,-25.0}}, rotation=90)));
    equation 
      connect(revolute1.frame_b,revolute2.frame_a) annotation(Line(visible=true, points={{-9.725,0.0},{35.0,0.0},{35.0,18.75}}, color={0,0,255}));
      connect(revolute2.frame_b,frame_b) annotation(Line(visible=true, points={{35.0,71.25},{35.0,90.0},{70.0,90.0},{70.0,0.0},{105.0,0.0}}, color={0,0,255}));
      connect(frame_a,revolute1.frame_a) annotation(Line(visible=true, origin={-84.1375,0.0}, points={{-20.8625,0.0},{20.8625,0.0}}, color={0,0,255}));
    end Universal;
...
model MultiBody_Examples_Loops_Engine2
  extends MultiBody.Examples.Loops.Engine2;
end MultiBody_Examples_Loops_Engine2;
