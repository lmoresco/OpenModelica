...
Simulate for 1 second (100 output points).
        ...
        Parts.InertialSystem inertial annotation(Placement(visible=true, transformation(origin={-70.0,-70.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        ...
        Parts.CylinderBody b3(r={L,0,0}, Radius=0.05) annotation(Placement(visible=true, transformation(origin={-26.0,50.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=0)));
        CutJoints.ConnectingRod2 barC(L=L, na={0,1,0}) annotation(Placement(visible=true, transformation(origin={-10.0,30.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=0)));
      equation 
        connect(j2.frame_b,b2.frame_a) annotation(Line(visible=true, points={{30.5,-70.0},{50.0,-70.0},{50.0,-60.5}}, color={0,0,255}));
        connect(barC.frame_a,b2.frame_b) annotation(Line(visible=true, points={{0.5,30.0},{50.0,30.0},{50.0,-39.5}}, color={0,0,255}));
        connect(j1.frame_b,b1.frame_a) annotation(Line(visible=true, points={{-33.5,-30.0},{-30.0,-30.0},{-30.0,-10.5}}, color={0,0,255}));
        connect(b1.frame_b,barC.frame_b) annotation(Line(visible=true, points={{-30.0,10.5},{-30.0,30.0},{-20.5,30.0}}, color={0,0,255}));
        connect(b3.frame_a,barC.frame_c) annotation(Line(visible=true, points={{-15.5,50.0},{-8.0,50.0},{-7.9,32.1}}, color={0,0,255}));
        connect(j1.frame_a,inertial.frame_b) annotation(Line(visible=true, points={{-54.5,-30.0},{-59.5,-30.0},{-59.5,-70.0}}, color={0,0,255}));
        connect(b0.frame_b,j2.frame_a) annotation(Line(visible=true, points={{0.5,-70.0},{9.5,-70.0}}, color={0,0,255}));
        connect(inertial.frame_b,b0.frame_a) annotation(Line(visible=true, points={{-59.5,-70.0},{-20.5,-70.0}}, color={0,0,255}));
        j1q=j1.q;
        j2q=j2.q;
        j1qd=j1.qd;
        j2qd=j2.qd;
...
model MultiBody_Examples_Loops_Fourbar1
  extends MultiBody.Examples.Loops.Fourbar1;
