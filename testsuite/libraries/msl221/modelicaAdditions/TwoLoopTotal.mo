...
"), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Text(lineColor={0,0,255}, extent={{-100,-70},{100,-130}}, textString="%name=%L", fillColor={0,0,255}),Ellipse(extent={{-90,-40},{-10,40}}, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{-80,-30},{-20,30}}, lineColor={255,0,0}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{-50,40},{-10,-40}}, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Ellipse(extent={{10,-40},{90,40}}, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{20,-29},{80,30}}, lineColor={192,192,192}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{10,40},{31,-40}}, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{-51,6},{48,-4}}, lineColor={0,0,0}, fillPattern=FillPattern.HorizontalCylinder, fillColor={255,0,0}),Ellipse(extent={{-64,15},{-35,-13}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{33,14},{62,-14}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid),Polygon(points={{-51,100},{-65,70},{-35,70},{-51,100},{-51,100}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid),Line(points={{-50,-4},{-50,70}}, color={0,0,0}, pattern=LinePattern.Solid, thickness=0.25, arrow={Arrow.None,Arrow.None}),Line(points={{-61,1},{18,1}}, color={0,0,0}, pattern=LinePattern.Solid, thickness=0.25, arrow={Arrow.None,Arrow.None}),Polygon(points={{41,0},{10,15},{10,-15},{41,0}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid),Text(lineColor={0,0,255}, extent={{-9,-15},{31,-55}}, textString="x", fillColor={0,0,0}),Text(lineColor={0,0,255}, extent={{-110,110},{-70,70}}, textString="y", fillColor={0,0,0}),Text(lineColor={0,0,255}, extent={{-6,74},{33,34}}, textString="c", fillColor={128,128,128})}), Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{-48,-60},{36,-60}}),Polygon(points={{46,-60},{31,-54},{31,-66},{46,-60}}, lineColor={0,0,255}, fillColor={0,0,255}, fillPattern=FillPattern.Solid),Text(lineColor={0,0,255}, extent={{-20,-65},{20,-100}}, textString="L"),Ellipse(extent={{-90,-40},{-10,40}}, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{-80,-31},{-20,29}}, lineColor={255,0,0}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{-45,40},{-10,-40}}, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Ellipse(extent={{10,-40},{90,40}}, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{20,-29},{80,30}}, lineColor={192,192,192}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{10,40},{31,-40}}, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{-51,6},{48,-4}}, lineColor={0,0,0}, fillPattern=FillPattern.HorizontalCylinder, fillColor={255,0,0}),Ellipse(extent={{-64,15},{-35,-13}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{33,14},{62,-14}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid),Line(color={0,0,255}, points={{48,-72},{48,0}}),Line(color={0,0,255}, points={{-50,-72},{-50,0}}),Text(lineColor={0,0,255}, extent={{17,9},{-3,34}}, textString="cut c")}));
    ...
    model Spherical "Spherical joint used as Cut-Joint"
      ...
      annotation(Diagram(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Ellipse(visible=true, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid, extent={{-60.0,-60.0},{60.0,60.0}}),Ellipse(visible=true, lineColor={255,0,0}, fillColor={255,255,255}, fillPattern=FillPattern.Solid, extent={{-45.0,-45.0},{45.0,45.0}}),Rectangle(visible=true, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid, extent={{20.0,-60.0},{60.0,60.0}}),Rectangle(visible=true, fillColor={255,0,0}, fillPattern=FillPattern.HorizontalCylinder, extent={{-90.0,-10.0},{-60.0,10.0}}),Rectangle(visible=true, fillColor={255,0,0}, fillPattern=FillPattern.HorizontalCylinder, extent={{23.0,-10.0},{90.0,10.0}}),Ellipse(visible=true, fillPattern=FillPattern.Solid, extent={{-25.0,25.0},{25.0,-25.0}})}), Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Ellipse(visible=true, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid, extent={{-60.0,-60.0},{60.0,60.0}}),Ellipse(visible=true, lineColor={255,0,0}, fillColor={255,255,255}, fillPattern=FillPattern.Solid, extent={{-45.0,-45.0},{45.0,45.0}}),Rectangle(visible=true, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid, extent={{20.0,-60.0},{60.0,60.0}}),Rectangle(visible=true, fillColor={255,0,0}, fillPattern=FillPattern.HorizontalCylinder, extent={{-90.0,-10.0},{-60.0,10.0}}),Rectangle(visible=true, fillColor={255,0,0}, fillPattern=FillPattern.HorizontalCylinder, extent={{23.0,-10.0},{90.0,10.0}}),Ellipse(visible=true, fillPattern=FillPattern.Solid, extent={{-25.0,25.0},{25.0,-25.0}}),Text(visible=true, lineColor={0,0,255}, fillPattern=FillPattern.Solid, extent={{27.0,28.0},{107.0,108.0}}, textString="C", fontName="Arial"),Text(visible=true, lineColor={0,0,255}, extent={{-100.0,-130.0},{100.0,-70.0}}, textString="%name", fontName="Arial")}), Documentation(info="<html>

<p>
A spherical joint is a joint with 3 rotational degrees of freedom. An instance
of this class is used as cut joint to break a kinematic loop of a multibody
system.

<p>
The 3 constraint equations on position level state, that the distance between
the origins of frame_a and frame_b is zero. As constraint forces fc (=
Lagrange multipliers) of the joint fc = fa  is used, i.e., the cut-forces at
frame_a.
...
"), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Ellipse(extent={{-60,-60},{60,60}}, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{-45,-45},{45,45}}, lineColor={255,0,0}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{20,60},{60,-60}}, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{-90,10},{-60,-10}}, lineColor={0,0,0}, fillPattern=FillPattern.HorizontalCylinder, fillColor={255,0,0}),Rectangle(extent={{23,10},{90,-10}}, lineColor={0,0,0}, fillPattern=FillPattern.HorizontalCylinder, fillColor={255,0,0}),Ellipse(extent={{-25,25},{25,-25}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid),Text(lineColor={0,0,255}, extent={{27,108},{107,28}}, textString="C", fillColor={0,0,0}),Text(lineColor={0,0,255}, extent={{-100,-130},{100,-70}}, textString="%name")}), Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Ellipse(extent={{-60,-60},{60,60}}, lineColor={255,0,0}, fillColor={255,0,0}, fillPattern=FillPattern.Solid),Ellipse(extent={{-45,-45},{45,45}}, lineColor={255,0,0}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{20,60},{60,-60}}, lineColor={255,255,255}, fillColor={255,255,255}, fillPattern=FillPattern.Solid),Rectangle(extent={{-90,10},{-60,-10}}, lineColor={0,0,0}, fillPattern=FillPattern.HorizontalCylinder, fillColor={255,0,0}),Rectangle(extent={{23,10},{90,-10}}, lineColor={0,0,0}, fillPattern=FillPattern.HorizontalCylinder, fillColor={255,0,0}),Ellipse(extent={{-25,25},{25,-25}}, lineColor={0,0,0}, fillColor={0,0,0}, fillPattern=FillPattern.Solid)}));
    equation 
      constraintResidue=r_rela "Constraint equations on position, velocity and acceleration level";
      constraintResidue_d=v_rela;
      constraintResidue_dd=a_rela;
      constrain(constraintResidue, constraintResidue_d, constraintResidue_dd);
      ta=zeros(3) "Cut-forces/torques at frame_a as function of the constraint forces";
      tb=zeros(3);
      fa=fc;
      fb=S_rel*fc;
    end Spherical;
...
<p>
Plot j1.q and j1.qd.
</html>", revisions=""), experiment(StopTime=1.6, Interval=0.01), Commands(file="TwoLoop.mos" "Simulate and plot angle and rotation of revolute joint"), Icon(coordinateSystem(extent={{-200.0,-200.0},{200.0,200.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Rectangle(visible=true, lineColor={0,0,255}, extent={{-200.0,-200.0},{160.0,100.0}}),Polygon(visible=true, lineColor={0,0,255}, points={{-200.0,100.0},{-158.0,140.0},{200.0,140.0},{160.0,100.0},{-200.0,100.0}}),Polygon(visible=true, lineColor={0,0,255}, points={{200.0,140.0},{200.0,-160.0},{160.0,-200.0},{160.0,100.0},{200.0,140.0}}),Text(visible=true, lineColor={0,0,255}, fillColor={0,0,255}, fillPattern=FillPattern.Solid, extent={{-170.0,-172.0},{132.0,68.0}}, textString="Example", fontName="Arial"),Text(visible=true, lineColor={0,0,255}, fillColor={255,0,0}, fillPattern=FillPattern.Solid, extent={{-200.0,140.0},{198.0,240.0}}, textString="%name", fontName="Arial")}), Diagram(coordinateSystem(extent={{-220.0,-120.0},{220.0,120.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})));
        Parts.InertialSystem inertial annotation(Placement(visible=true, transformation(origin={-190.0,-50.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Joints.Revolute j1(n={0,0,1}, startValueFixed=true) annotation(Placement(visible=true, transformation(origin={-50.0,-30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.CylinderBody b1(r={0.1,0.5,-0.5}, Radius=0.02) annotation(Placement(visible=true, transformation(origin={-30.0,10.0}, extent={{10.0,10.0},{-10.0,-10.0}}, rotation=-90)));
        CutJoints.ConnectingRod2 j2(L=1.1, na={1,0,0}) annotation(Placement(visible=true, transformation(origin={-10.0,50.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.CylinderBody b2(r={1.1,0,0}, Radius=0.02, Material={0,1,0,0.5}) annotation(Placement(visible=true, transformation(origin={8.0,90.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.ShapeBody b3(r={-0.2,0,0}, Width=0.04, Height=0.04, Material={0,0,1,0.5}) annotation(Placement(visible=true, transformation(origin={30.0,10.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=0)));
        Joints.Prismatic j3(n={1,0,0}) annotation(Placement(visible=true, transformation(origin={30.0,-50.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.ShapeBody b5(r={1.8,0,0}, Width=0.02, Height=0.02, Material={0.5,0.5,0.5,0.5}) annotation(Placement(visible=true, transformation(origin={-10.0,-50.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.CylinderBody b6(r={0,-0.3,0}, Radius=0.03) annotation(Placement(visible=true, transformation(origin={110.0,-10.0}, extent={{10.0,10.0},{-10.0,-10.0}}, rotation=-90)));
        Joints.Prismatic j5(n={0,0,1}, qq(start=-0.5, fixed=false)) annotation(Placement(visible=true, transformation(origin={130.0,-50.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=0)));
        Parts.ShapeBody b7(r={0,0,-0.3}, Width=0.03, Height=0.03, Material={0,1,0,0.5}) annotation(Placement(visible=true, transformation(origin={160.0,-50.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=0)));
        CutJoints.Spherical j4 annotation(Placement(visible=true, transformation(origin={74.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Joints.Revolute j6(n={-1,0,0}) annotation(Placement(visible=true, transformation(origin={186.0,-70.0}, extent={{10.0,10.0},{-10.0,-10.0}}, rotation=-90)));
        Joints.Revolute j7(n={0,1,0}) annotation(Placement(visible=true, transformation(origin={164.0,-90.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.ShapeBody b4(r={0,0,0.5}, Width=0.02, Height=0.02, Material={0.5,0.5,0.5,0.5}) annotation(Placement(visible=true, transformation(origin={30.0,-90.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.Shape shape(LengthDirection={0,0,0.4}, Width=0.02, Height=0.02) annotation(Placement(visible=true, transformation(origin={130.0,-30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.FrameAxes frame(nx={1,-1,1}) annotation(Placement(visible=true, transformation(origin={-142.0,-50.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Rotational.Torque torque annotation(Placement(visible=true, transformation(origin={-130.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Rotational.IdealGear gear(ratio=10) annotation(Placement(visible=true, transformation(origin={-100.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Rotational.Inertia shaft(J=0.5) annotation(Placement(visible=true, transformation(origin={-70.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Sources.Constant constIn(k=10) annotation(Placement(visible=true, transformation(origin={-168.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
        Parts.FrameTranslation b8(r={-0.8,0,0}) annotation(Placement(visible=true, transformation(origin={-90.0,-50.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      equation 
        connect(inertial.frame_b,frame.frame_a) annotation(Line(visible=true, points={{-179.5,-50.0},{-152.5,-50.0}}, color={0,0,255}));
        connect(j3.frame_b,b3.frame_a) annotation(Line(visible=true, points={{40.5,-50.0},{52.0,-50.0},{52.0,10.0},{40.5,10.0}}, color={0,0,255}));
        connect(b3.frame_b,j2.frame_b) annotation(Line(visible=true, points={{19.5,10.0},{10.0,10.0},{10.0,50.0},{0.5,50.0}}, color={0,0,255}));
        connect(j5.frame_b,shape.frame_a) annotation(Line(visible=true, points={{119.5,-50.0},{110.0,-50.0},{110.0,-30.0},{119.5,-30.0}}, color={0,0,255}));
        connect(b7.frame_b,j5.frame_a) annotation(Line(visible=true, points={{149.5,-50.0},{140.5,-50.0}}, color={0,0,255}));
        connect(j6.frame_b,b7.frame_a) annotation(Line(visible=true, points={{186.0,-59.5},{186.0,-50.0},{170.5,-50.0}}, color={0,0,255}));
        connect(b5.frame_b,j3.frame_a) annotation(Line(visible=true, points={{0.5,-50.0},{19.5,-50.0}}, color={0,0,255}));
        connect(b5.frame_b,b4.frame_a) annotation(Line(visible=true, points={{0.5,-50.0},{10.0,-50.0},{10.0,-90.0},{19.5,-90.0}}, color={0,0,255}));
        connect(b8.frame_b,b5.frame_a) annotation(Line(visible=true, points={{-79.5,-50.0},{-20.5,-50.0}}, color={0,0,255}));
        connect(b6.frame_b,j4.frame_b) annotation(Line(visible=true, points={{110.0,0.5},{110.0,10.0},{84.5,10.0}}, color={0,0,255}));
        connect(j5.frame_b,b6.frame_a) annotation(Line(visible=true, points={{119.5,-50.0},{110.0,-50.0},{110.0,-20.5}}, color={0,0,255}));
        connect(j2.frame_c,b2.frame_a) annotation(Line(visible=true, points={{-12.1,52.1},{-12.0,90.0},{-2.5,90.0}}, color={0,0,255}));
        connect(b1.frame_b,j2.frame_a) annotation(Line(visible=true, points={{-30.0,20.5},{-30.0,50.0},{-20.5,50.0}}, color={0,0,255}));
        connect(b1.frame_a,j1.frame_b) annotation(Line(visible=true, points={{-30.0,-0.5},{-30.0,-30.0},{-39.5,-30.0}}, color={0,0,255}));
        connect(j7.frame_b,j6.frame_a) annotation(Line(visible=true, points={{174.5,-90.0},{186.0,-90.0},{186.0,-80.5}}, color={0,0,255}));
        connect(b8.frame_b,j1.frame_a) annotation(Line(visible=true, points={{-79.5,-50.0},{-68.0,-50.0},{-68.0,-30.0},{-60.5,-30.0}}, color={0,0,255}));
        connect(frame.frame_b,b8.frame_a) annotation(Line(visible=true, points={{-131.5,-50.0},{-100.5,-50.0}}, color={0,0,255}));
        connect(j3.frame_b,j4.frame_a) annotation(Line(visible=true, points={{40.5,-50.0},{52.0,-50.0},{52.0,10.0},{63.5,10.0}}, color={0,0,255}));
        connect(shaft.flange_b,j1.axis) annotation(Line(visible=true, points={{-60.0,10.0},{-50.0,10.0},{-50.0,-23.0}}, color={0,0,255}));
        connect(gear.flange_b,shaft.flange_a) annotation(Line(visible=true, points={{-90.0,10.0},{-80.0,10.0}}, color={0,0,255}));
        connect(torque.flange_b,gear.flange_a) annotation(Line(visible=true, points={{-120.0,10.0},{-110.0,10.0}}, color={0,0,255}));
        connect(constIn.y,torque.tau) annotation(Line(visible=true, points={{-157.0,10.0},{-142.0,10.0}}, color={0,0,255}));
        connect(b4.frame_b,j7.frame_a) annotation(Line(visible=true, points={{40.5,-90.0},{153.5,-90.0}}, color={0,0,255}));
      end TwoLoop;
...
"), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Text(lineColor={0,0,255}, extent={{-99,-89},{101,-29}}, textString="%name=%r"),Rectangle(extent={{-90,5},{90,-5}}, fillPattern=FillPattern.Solid, lineColor={0,0,0}, fillColor={0,0,0}),Line(points={{80,20},{129,50}}, color={0,0,0}),Line(points={{80,20},{57,59}}, color={0,0,0}),Polygon(points={{158,69},{121,62},{136,40},{158,69}}, fillPattern=FillPattern.Solid, lineColor={0,0,0}, fillColor={0,0,0}),Polygon(points={{34,96},{46,50},{68,65},{34,96}}, fillPattern=FillPattern.Solid, lineColor={0,0,0}, fillColor={0,0,0})}), Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{-90,0},{-90,-65}}),Line(color={0,0,255}, points={{90,0},{90,-65}}),Line(color={0,0,255}, points={{-90,-60},{80,-60}}),Polygon(lineColor={0,0,255}, points={{80,-55},{80,-65},{90,-60},{80,-55}}, fillColor={0,0,255}, fillPattern=FillPattern.Solid),Text(lineColor={0,0,255}, extent={{-22,-36},{16,-60}}, textString="r"),Rectangle(extent={{-90,5},{90,-5}}, fillPattern=FillPattern.Solid, lineColor={0,0,0}, fillColor={0,0,0}),Line(color={0,0,255}, points={{69,29},{106,29}}, arrow={Arrow.None,Arrow.Filled}),Line(color={0,0,255}, points={{70,27},{70,59}}, arrow={Arrow.None,Arrow.Filled}),Text(lineColor={0,0,255}, extent={{92,44},{106,33}}, textString="x"),Text(lineColor={0,0,255}, extent={{51,66},{66,54}}, textString="y"),Line(color={0,0,255}, points={{-103,29},{-66,29}}, arrow={Arrow.None,Arrow.Filled}),Line(color={0,0,255}, points={{-102,27},{-102,59}}, arrow={Arrow.None,Arrow.Filled}),Text(lineColor={0,0,255}, extent={{-80,44},{-66,33}}, textString="x"),Text(lineColor={0,0,255}, extent={{-121,66},{-106,54}}, textString="y")}));
    equation 
      ...
      wb=S_rel*wa;
      zb=S_rel*za;
      fa=transpose(S_rel)*fb "Transform the force and torque acting at frame_b to frame_a";
...
"), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Text(lineColor={0,0,255}, extent={{-99,-100},{101,-40}}, textString="r=%r", fillColor={0,0,0}),Rectangle(extent={{-90,5},{90,-5}}, fillPattern=FillPattern.Solid, lineColor={0,0,0}, fillColor={0,0,0}),Text(lineColor={0,0,255}, extent={{-101,41},{99,101}}, textString="%name")}), Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{-90,0},{-90,-65}}),Line(color={0,0,255}, points={{90,0},{90,-65}}),Line(color={0,0,255}, points={{-90,-60},{80,-60}}),Polygon(lineColor={0,0,255}, points={{80,-55},{80,-65},{90,-60},{80,-55}}, fillColor={0,0,255}, fillPattern=FillPattern.Solid),Text(lineColor={0,0,255}, extent={{-22,-36},{16,-60}}, textString="r"),Rectangle(extent={{-90,5},{90,-5}}, fillPattern=FillPattern.Solid, lineColor={0,0,0}, fillColor={0,0,0}),Line(color={0,0,255}, points={{69,29},{106,29}}, arrow={Arrow.None,Arrow.Filled}),Line(color={0,0,255}, points={{70,27},{70,59}}, arrow={Arrow.None,Arrow.Filled}),Text(lineColor={0,0,255}, extent={{92,44},{106,33}}, textString="x"),Text(lineColor={0,0,255}, extent={{51,66},{66,54}}, textString="y"),Line(color={0,0,255}, points={{-103,29},{-66,29}}, arrow={Arrow.None,Arrow.Filled}),Line(color={0,0,255}, points={{-102,27},{-102,59}}, arrow={Arrow.None,Arrow.Filled}),Text(lineColor={0,0,255}, extent={{-80,44},{-66,33}}, textString="x"),Text(lineColor={0,0,255}, extent={{-121,66},{-106,54}}, textString="y")}));
    ...
    model FrameAxes "Fixed translation and rotation of frame_b with respect to frame_a"
      ...
      parameter String label1="x" "Label of horizontal axis in icon";
      parameter String label2="y" "Label of vertical axis in icon";
      annotation(Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, lineColor={0,0,255}, fillPattern=FillPattern.Solid, extent={{3.0,75.0},{31.0,97.0}}, textString="%label2", fontName="Arial"),Text(visible=true, lineColor={0,0,255}, fillPattern=FillPattern.Solid, extent={{129.0,80.0},{157.0,102.0}}, textString="%label1", fontName="Arial")}));
    protected 
      Real nz[3];
      Real nnx[3];
      Real nny[3];
      Real nnz[3];
      annotation(Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Text(lineColor={0,0,255}, extent={{3,97},{31,75}}, textString="%label2", fillColor={0,0,0}),Text(lineColor={0,0,255}, extent={{129,102},{157,80}}, textString="%label1", fillColor={0,0,0})}), Diagram(coordinateSystem(extent={{-100,-100},{100,100}})), Icon(coordinateSystem(extent={{-100,-100},{100,100}})));
    equation 
      nz=cross(nx, ny);
      nnz=nz/sqrt(nz*nz);
      nnx=nx/sqrt(nx*nx);
...
model MultiBody_Examples_Loops_TwoLoop
  extends MultiBody.Examples.Loops.TwoLoop;
end MultiBody_Examples_Loops_TwoLoop;
