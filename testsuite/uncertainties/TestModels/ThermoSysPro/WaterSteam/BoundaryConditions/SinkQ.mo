...
protected 
  ...
  annotation(Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{-90,0},{-40,0},{-54,10}}),Line(color={0,0,255}, points={{-54,-10},{-40,0}}),Text(lineColor={0,0,255}, extent={{12,60},{32,40}}, textString="Q"),Text(lineColor={0,0,255}, extent={{10,-40},{30,-60}}, textString="h"),Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillPattern=FillPattern.Solid, fillColor={255,255,0}),Text(lineColor={0,0,255}, extent={{-20,20},{22,-24}}, fillColor={0,0,255}, textString="Q")}), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillPattern=FillPattern.Solid, fillColor={255,255,0}),Text(lineColor={0,0,255}, extent={{12,60},{32,40}}, textString="Q"),Text(lineColor={0,0,255}, extent={{10,-40},{30,-60}}, textString="h"),Line(color={0,0,255}, points={{-90,0},{-40,0},{-54,10}}),Line(color={0,0,255}, points={{-54,-10},{-40,0}}),Text(lineColor={0,0,255}, extent={{-20,22},{22,-24}}, fillColor={0,0,255}, textString="Q")}), Documentation(info="<html>
