...
function Ps
  ...
  output ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ps pro annotation(Placement(transformation(x=-60.0, y=60.0, scale=0.2, aspectRatio=1.0, flipHorizontal=false, flipVertical=false)));
algorithm 
  if fluid == 1 then 
