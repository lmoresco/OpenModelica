...
model VolumeBTh "Mixing flue gases volume with 2 inlets and 2 outlets and thermal input"
  ...
  Connectors.FlueGasesInlet Ce2 annotation(Placement(transformation(x=100.0, y=0.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false), iconTransformation(x=100.0, y=0.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false)));
initial equation 
