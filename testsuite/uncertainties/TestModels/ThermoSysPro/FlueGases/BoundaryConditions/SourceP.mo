...
model SourceP "Flue gas source with fixed pressure"
  ...
  annotation(Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{40,0},{90,0},{72,10}}),Line(color={0,0,255}, points={{90,0},{72,-10}}),Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillColor={127,255,0}, fillPattern=FillPattern.Backward),Text(lineColor={0,0,255}, extent={{-94,28},{98,-28}}, textString="P"),Text(lineColor={0,0,255}, extent={{-64,26},{-40,6}}, fillColor={0,0,255}, textString="P"),Text(lineColor={0,0,255}, extent={{-40,-40},{-2,-60}}, fillColor={0,0,255}, textString="T")}), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{40,0},{90,0},{72,10}}),Line(color={0,0,255}, points={{90,0},{72,-10}}),Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillColor={127,255,0}, fillPattern=FillPattern.Backward),Text(lineColor={0,0,255}, extent={{-92,30},{100,-26}}, textString="P"),Text(lineColor={0,0,255}, extent={{-64,26},{-40,6}}, fillColor={0,0,255}, textString="P"),Text(lineColor={0,0,255}, extent={{-40,-40},{-2,-60}}, fillColor={0,0,255}, textString="T")}), Documentation(info="<html>
