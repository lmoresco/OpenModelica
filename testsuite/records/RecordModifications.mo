...
//   parameter Real x.B_r = x.B_rRef * (1.0 + x.alpha_Br * (x.T_op - x.T_ref));
//   parameter Real x.H_cB = x.H_cBRef * (1.0 + x.alpha_Br * (x.T_op - x.T_ref));
//   parameter Real x.mu_r = x.B_r * 1.0 / x.H_cB / 3.0;
...
//   parameter Real other.B_r = other.B_rRef * (1.0 + other.alpha_Br * (other.T_op - other.T_ref));
//   parameter Real other.H_cB = other.H_cBRef * (1.0 + other.alpha_Br * (other.T_op - other.T_ref));
//   parameter Real other.mu_r = other.B_r * 1.0 / other.H_cB / 3.0;
//   parameter Real y.H_cBRef = 900000.0;
//   parameter Real y.B_rRef = 1.2;
//   parameter Real y.T_ref = 303.15;
//   parameter Real y.alpha_Br = -0.001;
//   parameter Real y.T_op = 293.15;
//   parameter Real y.B_r = y.B_rRef * (1.0 + y.alpha_Br * (y.T_op - y.T_ref));
//   parameter Real y.H_cB = y.H_cBRef * (1.0 + y.alpha_Br * (y.T_op - y.T_ref));
//   parameter Real y.mu_r = y.B_r * 1.0 / y.H_cB / 3.0;
