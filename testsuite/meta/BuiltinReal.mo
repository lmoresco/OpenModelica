...
function funcRealTransform
  ...
  output Real outRealCos;
  output Real outRealSin;
  output Real outRealAtan;
  output Real outRealExp;
  output Real outRealLn;
  output Real outRealFloor;
  output Real outRealSqrt;
algorithm
  outRealAbs := realAbs(r);
  outRealNeg := realNeg(r);
  outRealCos := realCos(r);
  outRealSin := realSin(r);
  outRealAtan := realAtan(r);
  outRealExp := realExp(r);
  outRealLn := realLn(r);
  outRealFloor := realFloor(r);
  outRealSqrt := realSqrt(r);
