...
// Real R1.v(unit = "V");
// Real R1.i(unit = "A");
// parameter Real R1.R(unit = "Ohm") = 10 "Resistance";
// Real C.p.v(unit = "V");
// Real C.p.i(unit = "A");
// Real C.n.v(unit = "V");
// Real C.n.i(unit = "A");
...
// Real R2.v(unit = "V");
// Real R2.i(unit = "A");
// parameter Real R2.R(unit = "Ohm") = 100 "Resistance";
// Real L.p.v(unit = "V");
// Real L.p.i(unit = "A");
// Real L.n.v(unit = "V");
// Real L.n.i(unit = "A");
...
// Real AC.v(unit = "V");
// Real AC.i(unit = "A");
// parameter Real AC.VA(unit = "V") = 220 "Amplitude";
// parameter Real AC.f(unit = "Hz") = 50 "Frequency";
