...
//   Real p[4](start = WaveEquationSample.initialPressure(n)[4]);
//   Real p[5](start = WaveEquationSample.initialPressure(n)[5]);
//   Real p[6](start = WaveEquationSample.initialPressure(n)[6]);
//   Real p[7](start = WaveEquationSample.initialPressure(n)[7]);
//   Real p[8](start = WaveEquationSample.initialPressure(n)[8]);
//   Real p[9](start = WaveEquationSample.initialPressure(n)[9]);
//   Real p[10](start = WaveEquationSample.initialPressure(n)[10]);
//   Real p[11](start = WaveEquationSample.initialPressure(n)[11]);
//   Real p[12](start = WaveEquationSample.initialPressure(n)[12]);
//   Real p[13](start = WaveEquationSample.initialPressure(n)[13]);
//   Real p[14](start = WaveEquationSample.initialPressure(n)[14]);
//   Real p[15](start = WaveEquationSample.initialPressure(n)[15]);
//   Real p[16](start = WaveEquationSample.initialPressure(n)[16]);
//   Real p[17](start = WaveEquationSample.initialPressure(n)[17]);
//   Real p[18](start = WaveEquationSample.initialPressure(n)[18]);
//   Real p[19](start = WaveEquationSample.initialPressure(n)[19]);
//   Real p[20](start = WaveEquationSample.initialPressure(n)[20]);
//   Real p[21](start = WaveEquationSample.initialPressure(n)[21]);
//   Real p[22](start = WaveEquationSample.initialPressure(n)[22]);
//   Real p[23](start = WaveEquationSample.initialPressure(n)[23]);
//   Real p[24](start = WaveEquationSample.initialPressure(n)[24]);
//   Real p[25](start = WaveEquationSample.initialPressure(n)[25]);
//   Real p[26](start = WaveEquationSample.initialPressure(n)[26]);
//   Real p[27](start = WaveEquationSample.initialPressure(n)[27]);
//   Real p[28](start = WaveEquationSample.initialPressure(n)[28]);
//   Real p[29](start = WaveEquationSample.initialPressure(n)[29]);
//   Real p[30](start = WaveEquationSample.initialPressure(n)[30]);
//   Real dp[1](start = 0.0);
//   Real dp[2](start = 0.0);
//   Real dp[3](start = 0.0);
//   Real dp[4](start = 0.0);
