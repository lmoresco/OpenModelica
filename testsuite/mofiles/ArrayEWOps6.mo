...
//   for i in 1:3 loop
//     for j in 1:3 loop
//       c := <matrix>[/*T_REAL*/(i);/*T_REAL*/(j)];
//       z[-3 + (3 * i + j)] := exp(-(x[1,1] - c[1,1] / s[1,1]) ^ 2.0 - (x[2,1] - c[2,1] / s[1,2]) ^ 2.0);
//     end for;
//   end for;
...
// 
// class ArrayEWOps6
//   Real x[1] = 0.21966918422987414;
//   Real x[2] = 0.2820608158142204;
//   Real x[3] = 0.21966918422987414;
//   Real x[4] = 0.0808117767370727;
//   Real x[5] = 0.10376437529809651;
//   Real x[6] = 0.0808117767370727;
//   Real x[7] = 0.004023381453337195;
//   Real x[8] = 0.005166124047115023;
//   Real x[9] = 0.004023381453337195;
// end ArrayEWOps6;
// endResult
