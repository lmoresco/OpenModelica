...
// parameter enumeration(NoGravity, UniformGravity, PointGravity) w.gravityType = GravityTypes.UniformGravity "Type of gravity field";
// parameter Real w.g(quantity = "Acceleration", unit = "m/s2") = 9.81 "Constant gravity acceleration";
// parameter Real w.n[1] = 0 "Direction of gravity resolved in world frame (gravity = g*n/length(n))";
// parameter Real w.n[2] = -1 "Direction of gravity resolved in world frame (gravity = g*n/length(n))";
// parameter Real w.n[3] = 0 "Direction of gravity resolved in world frame (gravity = g*n/length(n))";
...
// input Integer w.axisColor_x[1] = 0 "Color of x-arrow";
// input Integer w.axisColor_x[2] = 0 "Color of x-arrow";
// input Integer w.axisColor_x[3] = 0 "Color of x-arrow";
// input Integer w.axisColor_y[1] = w.axisColor_x[1];
// input Integer w.axisColor_y[2] = w.axisColor_x[2];
// input Integer w.axisColor_y[3] = w.axisColor_x[3];
// input Integer w.axisColor_z[1] = w.axisColor_x[1] "Color of z-arrow";
// input Integer w.axisColor_z[2] = w.axisColor_x[2] "Color of z-arrow";
// input Integer w.axisColor_z[3] = w.axisColor_x[3] "Color of z-arrow";
// parameter Real w.gravityArrowTail[1](quantity = "Length", unit = "m") = 0 "Position vector from origin of world frame to arrow tail, resolved in world frame";
// parameter Real w.gravityArrowTail[2](quantity = "Length", unit = "m") = 0 "Position vector from origin of world frame to arrow tail, resolved in world frame";
// parameter Real w.gravityArrowTail[3](quantity = "Length", unit = "m") = 0 "Position vector from origin of world frame to arrow tail, resolved in world frame";
...
// input Integer w.gravityArrowColor[1] = 0 "Color of gravity arrow";
// input Integer w.gravityArrowColor[2] = 230 "Color of gravity arrow";
// input Integer w.gravityArrowColor[3] = 0 "Color of gravity arrow";
// parameter Real w.gravitySphereDiameter(quantity = "Length", unit = "m", min = 0.0) = 12742000 "Diameter of sphere representing gravity center (default = mean diameter of earth)";
// input Integer w.gravitySphereColor[1] = 0 "Color of gravity sphere";
// input Integer w.gravitySphereColor[2] = 230 "Color of gravity sphere";
// input Integer w.gravitySphereColor[3] = 0 "Color of gravity sphere";
// parameter Real w.nominalLength(quantity = "Length", unit = "m") = 1 "\"Nominal\" length of multi-body system";
...
// parameter Real w.defaultWidthFraction = 20 "Default for shape width as a fraction of shape length (e.g., for Parts.FixedTranslation)";
...
// parameter Real w.defaultFrameDiameterFraction = 40 "Default for arrow diameter of a coordinate system as a fraction of axis length";
...
// parameter Real w.defaultN_to_m(unit = "N/m", min = 0.0) = 1000 "Default scaling of force arrows (length = force/defaultN_to_m)";
// parameter Real w.defaultNm_to_m(unit = "N.m/m", min = 0.0) = 1000 "Default scaling of torque arrows (length = torque/defaultNm_to_m)";
// end ArrayAsAlias;
