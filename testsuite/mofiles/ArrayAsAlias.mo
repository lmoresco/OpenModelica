...
// parameter Real w.n[1] = 0.0 "Direction of gravity resolved in world frame (gravity = g*n/length(n))";
// parameter Real w.n[2] = -1.0 "Direction of gravity resolved in world frame (gravity = g*n/length(n))";
// parameter Real w.n[3] = 0.0 "Direction of gravity resolved in world frame (gravity = g*n/length(n))";
