...
//   pendulum.cart.body.rCM[1] = pendulum.cart.r0[1] + pendulum.cart.l * pendulum.cart.box.nLength[1] / 2.0;
//   pendulum.cart.body.rCM[2] = pendulum.cart.r0[2] + pendulum.cart.l * pendulum.cart.box.nLength[2] / 2.0;
//   pendulum.cart.body.rCM[3] = pendulum.cart.r0[3] + pendulum.cart.l * pendulum.cart.box.nLength[3] / 2.0;
//   pendulum.cart.body.I[1,1] = pendulum.cart.Sbox[1,1] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0) / 12.0) + (pendulum.cart.Sbox[1,2] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0) / 12.0) + pendulum.cart.Sbox[1,3] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0) / 12.0));
...
//   pendulum.cart.body.I[2,2] = pendulum.cart.Sbox[2,1] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0) / 12.0) + (pendulum.cart.Sbox[2,2] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0) / 12.0) + pendulum.cart.Sbox[2,3] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0) / 12.0));
...
//   pendulum.cart.body.I[3,3] = pendulum.cart.Sbox[3,1] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0) / 12.0) + (pendulum.cart.Sbox[3,2] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0) / 12.0) + pendulum.cart.Sbox[3,3] ^ 2.0 * (pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0) / 12.0 - pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0) / 12.0));
...
//   pendulum.pendulum.body.I[1,1] = pendulum.pendulum.Scyl[1,1] ^ 2.0 * (pendulum.pendulum.mo * pendulum.pendulum.Radius ^ 2.0 / 2.0 - pendulum.pendulum.mi * pendulum.pendulum.InnerRadius ^ 2.0 / 2.0) + (pendulum.pendulum.Scyl[1,2] ^ 2.0 * pendulum.pendulum.I22 + pendulum.pendulum.Scyl[1,3] ^ 2.0 * pendulum.pendulum.I22);
...
//   pendulum.pendulum.body.I[2,2] = pendulum.pendulum.Scyl[2,1] ^ 2.0 * (pendulum.pendulum.mo * pendulum.pendulum.Radius ^ 2.0 / 2.0 - pendulum.pendulum.mi * pendulum.pendulum.InnerRadius ^ 2.0 / 2.0) + (pendulum.pendulum.Scyl[2,2] ^ 2.0 * pendulum.pendulum.I22 + pendulum.pendulum.Scyl[2,3] ^ 2.0 * pendulum.pendulum.I22);
...
//   pendulum.pendulum.body.I[3,3] = pendulum.pendulum.Scyl[3,1] ^ 2.0 * (pendulum.pendulum.mo * pendulum.pendulum.Radius ^ 2.0 / 2.0 - pendulum.pendulum.mi * pendulum.pendulum.InnerRadius ^ 2.0 / 2.0) + (pendulum.pendulum.Scyl[3,2] ^ 2.0 * pendulum.pendulum.I22 + pendulum.pendulum.Scyl[3,3] ^ 2.0 * pendulum.pendulum.I22);
...
//   pendulum.pendulumJoint.S_rel[1,1] = pendulum.pendulumJoint.nn[1] ^ 2.0 + pendulum.pendulumJoint.cosq * (1.0 - pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.nn[1]);
...
//   pendulum.pendulumJoint.S_rel[2,2] = pendulum.pendulumJoint.nn[2] ^ 2.0 + pendulum.pendulumJoint.cosq * (1.0 - pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.nn[2]);
...
//   pendulum.pendulumJoint.S_rel[3,3] = pendulum.pendulumJoint.nn[3] ^ 2.0 + pendulum.pendulumJoint.cosq * (1.0 - pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.nn[3]);
