...
//   Real pendulum.pendulum.box.mcShape.e_x[1] = if noEvent(pendulum.pendulum.box.mcShape.abs_n_x < 1e-010) then 1.0 else pendulum.pendulum.box.mcShape.lengthDirection[1] / pendulum.pendulum.box.mcShape.abs_n_x;
//   Real pendulum.pendulum.box.mcShape.e_x[2] = if noEvent(pendulum.pendulum.box.mcShape.abs_n_x < 1e-010) then 0.0 else pendulum.pendulum.box.mcShape.lengthDirection[2] / pendulum.pendulum.box.mcShape.abs_n_x;
//   Real pendulum.pendulum.box.mcShape.e_x[3] = if noEvent(pendulum.pendulum.box.mcShape.abs_n_x < 1e-010) then 0.0 else pendulum.pendulum.box.mcShape.lengthDirection[3] / pendulum.pendulum.box.mcShape.abs_n_x;
...
//   Real pendulum.pendulum.box.mcShape.e_y[1] = cross(MCVisualShape.local_normalize(cross({pendulum.pendulum.box.mcShape.e_x[1],pendulum.pendulum.box.mcShape.e_x[2],pendulum.pendulum.box.mcShape.e_x[3]},if noEvent(pendulum.pendulum.box.mcShape.n_z_aux[1] ^ 2.0 + (pendulum.pendulum.box.mcShape.n_z_aux[2] ^ 2.0 + pendulum.pendulum.box.mcShape.n_z_aux[3] ^ 2.0) > 1e-006) then {pendulum.pendulum.box.mcShape.widthDirection[1],pendulum.pendulum.box.mcShape.widthDirection[2],pendulum.pendulum.box.mcShape.widthDirection[3]} else if noEvent(abs(pendulum.pendulum.box.mcShape.e_x[1]) > 1e-006) then {0.0,1.0,0.0} else {1.0,0.0,0.0})),{pendulum.pendulum.box.mcShape.e_x[1],pendulum.pendulum.box.mcShape.e_x[2],pendulum.pendulum.box.mcShape.e_x[3]})[1];
...
//   Real pendulum.cart.box.mcShape.e_x[1] = if noEvent(pendulum.cart.box.mcShape.abs_n_x < 1e-010) then 1.0 else pendulum.cart.box.mcShape.lengthDirection[1] / pendulum.cart.box.mcShape.abs_n_x;
//   Real pendulum.cart.box.mcShape.e_x[2] = if noEvent(pendulum.cart.box.mcShape.abs_n_x < 1e-010) then 0.0 else pendulum.cart.box.mcShape.lengthDirection[2] / pendulum.cart.box.mcShape.abs_n_x;
//   Real pendulum.cart.box.mcShape.e_x[3] = if noEvent(pendulum.cart.box.mcShape.abs_n_x < 1e-010) then 0.0 else pendulum.cart.box.mcShape.lengthDirection[3] / pendulum.cart.box.mcShape.abs_n_x;
...
//   Real pendulum.cart.box.mcShape.e_y[1] = cross(MCVisualShape.local_normalize(cross({pendulum.cart.box.mcShape.e_x[1],pendulum.cart.box.mcShape.e_x[2],pendulum.cart.box.mcShape.e_x[3]},if noEvent(pendulum.cart.box.mcShape.n_z_aux[1] ^ 2.0 + (pendulum.cart.box.mcShape.n_z_aux[2] ^ 2.0 + pendulum.cart.box.mcShape.n_z_aux[3] ^ 2.0) > 1e-006) then {pendulum.cart.box.mcShape.widthDirection[1],pendulum.cart.box.mcShape.widthDirection[2],pendulum.cart.box.mcShape.widthDirection[3]} else if noEvent(abs(pendulum.cart.box.mcShape.e_x[1]) > 1e-006) then {0.0,1.0,0.0} else {1.0,0.0,0.0})),{pendulum.cart.box.mcShape.e_x[1],pendulum.cart.box.mcShape.e_x[2],pendulum.cart.box.mcShape.e_x[3]})[1];
...
//   parameter Real controller.pulse.width(min = 1e-060, max = 100.0) = 50.0 "Width of pulse in % of periods";
//   parameter Real controller.pulse.period(quantity = "Time", unit = "s", min = 1e-060) = 10.0 "Time for one period";
...
//   pendulum.pendulumJoint.S_rel[2,2] = pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.nn[2] + pendulum.pendulumJoint.cosq * (1.0 - pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.nn[2]);
...
//   pendulum.pendulumJoint.S_rel[3,3] = pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.nn[3] + pendulum.pendulumJoint.cosq * (1.0 - pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.nn[3]);
...
//   pendulum.pendulum.box.mcShape.Form = 9.87e+025 + 1e+020 * PackShape(pendulum.pendulum.box.mcShape.shapeType);
...
//   pendulum.cart.box.mcShape.Form = 9.87e+025 + 1e+020 * PackShape(pendulum.cart.box.mcShape.shapeType);
...
//     (controller.timeTable.a, controller.timeTable.b, controller.timeTable.nextEvent, controller.timeTable.last) := Modelica.Blocks.Sources.TimeTable.getInterpolationCoefficients({{controller.timeTable.table[1,1],controller.timeTable.table[1,2]},{controller.timeTable.table[2,1],controller.timeTable.table[2,2]},{controller.timeTable.table[3,1],controller.timeTable.table[3,2]},{controller.timeTable.table[4,1],controller.timeTable.table[4,2]},{controller.timeTable.table[5,1],controller.timeTable.table[5,2]},{controller.timeTable.table[6,1],controller.timeTable.table[6,2]},{controller.timeTable.table[7,1],controller.timeTable.table[7,2]}},controller.timeTable.offset,controller.timeTable.startTime,time,controller.timeTable.last,1e-013);
//   end when;
// end IntroductoryExamples_Systems_InvertedPendulum;
