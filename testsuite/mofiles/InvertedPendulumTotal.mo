...
//   input Real pendulum.pendulum.box.mcShape.color[1] = pendulum.pendulum.box.Material[1] * 255.0 "Color of shape";
//   input Real pendulum.pendulum.box.mcShape.color[2] = pendulum.pendulum.box.Material[2] * 255.0 "Color of shape";
//   input Real pendulum.pendulum.box.mcShape.color[3] = pendulum.pendulum.box.Material[3] * 255.0 "Color of shape";
...
//   Real pendulum.pendulum.box.mcShape.e_x[1] = if noEvent(pendulum.pendulum.box.mcShape.abs_n_x < 0.0000000001) then 1.0 else pendulum.pendulum.box.mcShape.lengthDirection[1] / pendulum.pendulum.box.mcShape.abs_n_x;
//   Real pendulum.pendulum.box.mcShape.e_x[2] = if noEvent(pendulum.pendulum.box.mcShape.abs_n_x < 0.0000000001) then 0.0 else pendulum.pendulum.box.mcShape.lengthDirection[2] / pendulum.pendulum.box.mcShape.abs_n_x;
//   Real pendulum.pendulum.box.mcShape.e_x[3] = if noEvent(pendulum.pendulum.box.mcShape.abs_n_x < 0.0000000001) then 0.0 else pendulum.pendulum.box.mcShape.lengthDirection[3] / pendulum.pendulum.box.mcShape.abs_n_x;
...
//   Real pendulum.pendulum.box.mcShape.e_y[1] = cross(MCVisualShape.local_normalize(cross({pendulum.pendulum.box.mcShape.e_x[1],pendulum.pendulum.box.mcShape.e_x[2],pendulum.pendulum.box.mcShape.e_x[3]},if noEvent(pendulum.pendulum.box.mcShape.n_z_aux[1] ^ 2.0 + (pendulum.pendulum.box.mcShape.n_z_aux[2] ^ 2.0 + pendulum.pendulum.box.mcShape.n_z_aux[3] ^ 2.0) > 0.000001) then {pendulum.pendulum.box.mcShape.widthDirection[1],pendulum.pendulum.box.mcShape.widthDirection[2],pendulum.pendulum.box.mcShape.widthDirection[3]} else if noEvent(abs(pendulum.pendulum.box.mcShape.e_x[1]) > 0.000001) then {0.0,1.0,0.0} else {1.0,0.0,0.0})),{pendulum.pendulum.box.mcShape.e_x[1],pendulum.pendulum.box.mcShape.e_x[2],pendulum.pendulum.box.mcShape.e_x[3]})[1];
...
//   input Real pendulum.cart.box.mcShape.color[1] = pendulum.cart.box.Material[1] * 255.0 "Color of shape";
//   input Real pendulum.cart.box.mcShape.color[2] = pendulum.cart.box.Material[2] * 255.0 "Color of shape";
//   input Real pendulum.cart.box.mcShape.color[3] = pendulum.cart.box.Material[3] * 255.0 "Color of shape";
...
//   Real pendulum.cart.box.mcShape.e_x[1] = if noEvent(pendulum.cart.box.mcShape.abs_n_x < 0.0000000001) then 1.0 else pendulum.cart.box.mcShape.lengthDirection[1] / pendulum.cart.box.mcShape.abs_n_x;
//   Real pendulum.cart.box.mcShape.e_x[2] = if noEvent(pendulum.cart.box.mcShape.abs_n_x < 0.0000000001) then 0.0 else pendulum.cart.box.mcShape.lengthDirection[2] / pendulum.cart.box.mcShape.abs_n_x;
//   Real pendulum.cart.box.mcShape.e_x[3] = if noEvent(pendulum.cart.box.mcShape.abs_n_x < 0.0000000001) then 0.0 else pendulum.cart.box.mcShape.lengthDirection[3] / pendulum.cart.box.mcShape.abs_n_x;
...
//   Real pendulum.cart.box.mcShape.e_y[1] = cross(MCVisualShape.local_normalize(cross({pendulum.cart.box.mcShape.e_x[1],pendulum.cart.box.mcShape.e_x[2],pendulum.cart.box.mcShape.e_x[3]},if noEvent(pendulum.cart.box.mcShape.n_z_aux[1] ^ 2.0 + (pendulum.cart.box.mcShape.n_z_aux[2] ^ 2.0 + pendulum.cart.box.mcShape.n_z_aux[3] ^ 2.0) > 0.000001) then {pendulum.cart.box.mcShape.widthDirection[1],pendulum.cart.box.mcShape.widthDirection[2],pendulum.cart.box.mcShape.widthDirection[3]} else if noEvent(abs(pendulum.cart.box.mcShape.e_x[1]) > 0.000001) then {0.0,1.0,0.0} else {1.0,0.0,0.0})),{pendulum.cart.box.mcShape.e_x[1],pendulum.cart.box.mcShape.e_x[2],pendulum.cart.box.mcShape.e_x[3]})[1];
...
//   pendulum.pendulumJoint.S_rel[1,1] = pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.nn[1] + (1.0 - pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.nn[1]) * pendulum.pendulumJoint.cosq;
//   pendulum.pendulumJoint.S_rel[1,2] = pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.nn[2] + (-pendulum.pendulumJoint.nn[1]) * pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.cosq - (-pendulum.pendulumJoint.nn[3]) * pendulum.pendulumJoint.sinq;
//   pendulum.pendulumJoint.S_rel[1,3] = pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.nn[3] + (-pendulum.pendulumJoint.nn[1]) * pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.cosq - pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.sinq;
//   pendulum.pendulumJoint.S_rel[2,1] = pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.nn[1] + (-pendulum.pendulumJoint.nn[2]) * pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.cosq - pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.sinq;
//   pendulum.pendulumJoint.S_rel[2,2] = pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.nn[2] + (1.0 - pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.nn[2]) * pendulum.pendulumJoint.cosq;
//   pendulum.pendulumJoint.S_rel[2,3] = pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.nn[3] + (-pendulum.pendulumJoint.nn[2]) * pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.cosq - (-pendulum.pendulumJoint.nn[1]) * pendulum.pendulumJoint.sinq;
//   pendulum.pendulumJoint.S_rel[3,1] = pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.nn[1] + (-pendulum.pendulumJoint.nn[3]) * pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.cosq - (-pendulum.pendulumJoint.nn[2]) * pendulum.pendulumJoint.sinq;
//   pendulum.pendulumJoint.S_rel[3,2] = pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.nn[2] + (-pendulum.pendulumJoint.nn[3]) * pendulum.pendulumJoint.nn[2] * pendulum.pendulumJoint.cosq - pendulum.pendulumJoint.nn[1] * pendulum.pendulumJoint.sinq;
//   pendulum.pendulumJoint.S_rel[3,3] = pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.nn[3] + (1.0 - pendulum.pendulumJoint.nn[3] * pendulum.pendulumJoint.nn[3]) * pendulum.pendulumJoint.cosq;
...
//   pendulum.pendulum.mo = 3141.592653589793 * (pendulum.pendulum.rho * (pendulum.pendulum.length * pendulum.pendulum.Radius ^ 2.0));
...
//   pendulum.pendulum.body.rCM[1] = pendulum.pendulum.r0[1] + (pendulum.pendulum.box.nLength[1] * pendulum.pendulum.length) / 2.0;
//   pendulum.pendulum.body.rCM[2] = pendulum.pendulum.r0[2] + (pendulum.pendulum.box.nLength[2] * pendulum.pendulum.length) / 2.0;
//   pendulum.pendulum.body.rCM[3] = pendulum.pendulum.r0[3] + (pendulum.pendulum.box.nLength[3] * pendulum.pendulum.length) / 2.0;
...
//   pendulum.cart.body.rCM[1] = pendulum.cart.r0[1] + (pendulum.cart.box.nLength[1] * pendulum.cart.l) / 2.0;
//   pendulum.cart.body.rCM[2] = pendulum.cart.r0[2] + (pendulum.cart.box.nLength[2] * pendulum.cart.l) / 2.0;
//   pendulum.cart.body.rCM[3] = pendulum.cart.r0[3] + (pendulum.cart.box.nLength[3] * pendulum.cart.l) / 2.0;
//   pendulum.cart.body.I[1,1] = pendulum.cart.Sbox[1,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,1] + (pendulum.cart.Sbox[1,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,2] + pendulum.cart.Sbox[1,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,3]);
//   pendulum.cart.body.I[1,2] = pendulum.cart.Sbox[1,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,1] + (pendulum.cart.Sbox[1,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,2] + pendulum.cart.Sbox[1,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,3]);
//   pendulum.cart.body.I[1,3] = pendulum.cart.Sbox[1,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,1] + (pendulum.cart.Sbox[1,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,2] + pendulum.cart.Sbox[1,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,3]);
//   pendulum.cart.body.I[2,1] = pendulum.cart.Sbox[2,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,1] + (pendulum.cart.Sbox[2,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,2] + pendulum.cart.Sbox[2,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,3]);
//   pendulum.cart.body.I[2,2] = pendulum.cart.Sbox[2,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,1] + (pendulum.cart.Sbox[2,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,2] + pendulum.cart.Sbox[2,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,3]);
//   pendulum.cart.body.I[2,3] = pendulum.cart.Sbox[2,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,1] + (pendulum.cart.Sbox[2,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,2] + pendulum.cart.Sbox[2,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,3]);
//   pendulum.cart.body.I[3,1] = pendulum.cart.Sbox[3,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,1] + (pendulum.cart.Sbox[3,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,2] + pendulum.cart.Sbox[3,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[1,3]);
//   pendulum.cart.body.I[3,2] = pendulum.cart.Sbox[3,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,1] + (pendulum.cart.Sbox[3,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,2] + pendulum.cart.Sbox[3,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[2,3]);
//   pendulum.cart.body.I[3,3] = pendulum.cart.Sbox[3,1] * ((pendulum.cart.mo * (pendulum.cart.w ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.wi ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,1] + (pendulum.cart.Sbox[3,2] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.h ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.hi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,2] + pendulum.cart.Sbox[3,3] * ((pendulum.cart.mo * (pendulum.cart.l ^ 2.0 + pendulum.cart.w ^ 2.0)) / 12.0 - (pendulum.cart.mi * (pendulum.cart.l ^ 2.0 + pendulum.cart.wi ^ 2.0)) / 12.0) * pendulum.cart.Sbox[3,3]);
...
//     (controller.timeTable.a, controller.timeTable.b, controller.timeTable.nextEvent, controller.timeTable.last) := Modelica.Blocks.Sources.TimeTable.getInterpolationCoefficients({{controller.timeTable.table[1,1],controller.timeTable.table[1,2]},{controller.timeTable.table[2,1],controller.timeTable.table[2,2]},{controller.timeTable.table[3,1],controller.timeTable.table[3,2]},{controller.timeTable.table[4,1],controller.timeTable.table[4,2]},{controller.timeTable.table[5,1],controller.timeTable.table[5,2]},{controller.timeTable.table[6,1],controller.timeTable.table[6,2]},{controller.timeTable.table[7,1],controller.timeTable.table[7,2]}},controller.timeTable.offset,controller.timeTable.startTime,time,controller.timeTable.last,0.0000000000001);
//   end when;
// end IntroductoryExamples_Systems_InvertedPendulum;
// [InvertedPendulumTotal.mo:1709:11-1709:304:writable] Warning: If-equations are only partially supported. Ignoring   assert(controller.limiter.u >= -10.0 + -0.01 * abs(-10.0) and controller.limiter.u <= 10.0 + 0.01 * abs(10.0),"Limiter: During initialization the limits have been ignored.However, the result is that the input u is not within the required limits:  u = " + String(controller.limiter.u,0,true,6) + ", uMin = " + String(-10.0,0,true,6) + ", uMax = " + String(10.0,0,true,6));
// 
// endResult
