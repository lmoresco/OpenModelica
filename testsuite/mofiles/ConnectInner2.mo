...
// end ConnectInner2;
// [ConnectInner2.mo:20:3-20:6:writable] Warning: Variable b.a: No corresponding 'inner' declaration found for component b.a.global declared as 'outer '.
...
// [ConnectInner2.mo:26:3-26:6:writable] Warning: Variable a: No corresponding 'inner' declaration found for component a.global declared as 'outer '.
//   The existing 'inner' components are: 
//     There are no 'inner' components defined in the model in any of the parent scopes of 'outer' component's scope: A.
//   Check if you have not misspelled the 'outer' component name.
//   Please declare an 'inner' component with the same name in the top scope.
