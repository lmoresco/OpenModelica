...
// equation
//   M[1] = A[1] + ((B[1,1] + (C[1,1] ^ 2.0 + (C[1,2] * C[2,1] + C[1,3] * C[3,1]))) * D[1] + ((B[1,2] + (C[1,1] * C[1,2] + (C[1,2] * C[2,2] + C[1,3] * C[3,2]))) * D[2] + (B[1,3] + (C[1,1] * C[1,3] + (C[1,2] * C[2,3] + C[1,3] * C[3,3]))) * D[3]));
//   M[2] = A[2] + ((B[2,1] + (C[2,1] * C[1,1] + (C[2,2] * C[2,1] + C[2,3] * C[3,1]))) * D[1] + ((B[2,2] + (C[2,1] * C[1,2] + (C[2,2] ^ 2.0 + C[2,3] * C[3,2]))) * D[2] + (B[2,3] + (C[2,1] * C[1,3] + (C[2,2] * C[2,3] + C[2,3] * C[3,3]))) * D[3]));
