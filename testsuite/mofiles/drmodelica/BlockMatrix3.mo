...
// [BlockMatrix3.mo:16:15-17:15:writable] Error: Type mismatch in equation Q[{4,5,6},{1,2,3}]=cat(2,{{Q[1,1],Q[1,2],Q[1,3]},{Q[2,1],Q[2,2],Q[2,3]}},promote(-Q[3,{1,2,3}],1)) of type Real[3, 3]=Real[3, 4]
// 
