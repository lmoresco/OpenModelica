...
// equation
//   m[1,1] = n[1,1] * n[1,1] + (n[1,2] * n[2,1] + n[1,3] * n[3,1]);
//   m[1,2] = n[1,1] * n[1,2] + (n[1,2] * n[2,2] + n[1,3] * n[3,2]);
//   m[1,3] = n[1,1] * n[1,3] + (n[1,2] * n[2,3] + n[1,3] * n[3,3]);
//   m[2,1] = n[2,1] * n[1,1] + (n[2,2] * n[2,1] + n[2,3] * n[3,1]);
//   m[2,2] = n[2,1] * n[1,2] + (n[2,2] * n[2,2] + n[2,3] * n[3,2]);
//   m[2,3] = n[2,1] * n[1,3] + n[2,3] * (n[3,3] + n[2,2]);
//   m[3,1] = n[3,1] * n[1,1] + (n[3,2] * n[2,1] + n[3,3] * n[3,1]);
//   m[3,2] = n[3,1] * n[1,2] + n[3,2] * (n[2,2] + n[3,3]);
//   m[3,3] = n[3,1] * n[1,3] + (n[3,2] * n[2,3] + n[3,3] * n[3,3]);
//   m1[1,1] = n[1,1];
//   m1[1,2] = n[1,2];
//   m1[1,3] = n[1,3];
//   m1[2,1] = n[2,1];
