...
// fclass Gear
// parameter Real fixed1.phi0 = 0 "Fixed offset angle of housing";
// Real fixed1.flange_b.phi "Absolute rotation angle of flange";
// Real fixed1.flange_b.tau "Cut torque in the flange";
// Real springDamper1.phi_rel(start = 0.0) "Relative rotation angle (= flange_b.phi - flange_a.phi)";
// Real springDamper1.tau "Torque between flanges (= flange_b.tau)";
// Real springDamper1.flange_a.phi "Absolute rotation angle of flange";
// Real springDamper1.flange_a.tau "Cut torque in the flange";
// Real springDamper1.flange_b.phi "Absolute rotation angle of flange";
// Real springDamper1.flange_b.tau "Cut torque in the flange";
// parameter Real springDamper1.c = 10 "Spring constant";
// parameter Real springDamper1.phi_rel0 = 0 "Unstretched spring angle";
// parameter Real springDamper1.d = 1 "Damping constant";
// Real springDamper1.w_rel "Relative angular velocity between flange_b and flange_a";
// Real inertia1.phi "Absolute rotation angle of component (= flange_a.phi = flange_b.phi)";
// Real inertia1.flange_a.phi "Absolute rotation angle of flange";
// Real inertia1.flange_a.tau "Cut torque in the flange";
// Real inertia1.flange_b.phi "Absolute rotation angle of flange";
// Real inertia1.flange_b.tau "Cut torque in the flange";
// parameter Real inertia1.J = 1 "Moment of inertia";
// Real inertia1.w "Absolute angular velocity of component";
// Real inertia1.a "Absolute angular acceleration of component";
// Real springDamper2.phi_rel(start = 0.0) "Relative rotation angle (= flange_b.phi - flange_a.phi)";
// Real springDamper2.tau "Torque between flanges (= flange_b.tau)";
// Real springDamper2.flange_a.phi "Absolute rotation angle of flange";
// Real springDamper2.flange_a.tau "Cut torque in the flange";
// Real springDamper2.flange_b.phi "Absolute rotation angle of flange";
// Real springDamper2.flange_b.tau "Cut torque in the flange";
// parameter Real springDamper2.c = 1000 "Spring constant";
// parameter Real springDamper2.phi_rel0 = 0 "Unstretched spring angle";
// parameter Real springDamper2.d = 10 "Damping constant";
// Real springDamper2.w_rel "Relative angular velocity between flange_b and flange_a";
// Real inertia2.phi "Absolute rotation angle of component (= flange_a.phi = flange_b.phi)";
// Real inertia2.flange_a.phi "Absolute rotation angle of flange";
// Real inertia2.flange_a.tau "Cut torque in the flange";
// Real inertia2.flange_b.phi "Absolute rotation angle of flange";
// Real inertia2.flange_b.tau "Cut torque in the flange";
// parameter Real inertia2.J = 1 "Moment of inertia";
// Real inertia2.w "Absolute angular velocity of component";
// Real inertia2.a "Absolute angular acceleration of component";
// Real torque1.tau "Torque driving the flange (a positive value accelerates the flange)";
// Real torque1.flange_b.phi "Absolute rotation angle of flange";
// Real torque1.flange_b.tau "Cut torque in the flange";
// Real torque1.bearing.phi "Absolute rotation angle of flange";
// Real torque1.bearing.tau "Cut torque in the flange";
// Real sine1.y "Connector of Real output signal";
// parameter Real sine1.amplitude = 1 "Amplitude of sine wave";
// parameter Real sine1.freqHz = 1 "Frequency of sine wave";
// parameter Real sine1.phase = 0 "Phase of sine wave";
// parameter Real sine1.offset = 0 "Offset of output signal";
// parameter Real sine1.startTime = 0 "Output = offset for time < startTime";
// constant Real sine1.pi = 3.14159265358979;
// Real gear1.flange_a.phi "Absolute rotation angle of flange";
// Real gear1.flange_a.tau "Cut torque in the flange";
// Real gear1.flange_b.phi "Absolute rotation angle of flange";
// Real gear1.flange_b.tau "Cut torque in the flange";
// Real gear1.tau_support;
// Real gear1.bearing.phi "Absolute rotation angle of flange";
// Real gear1.bearing.tau "Cut torque in the flange";
// Real gear1.adapter.flange_a.phi "Absolute rotation angle of flange";
// Real gear1.adapter.flange_a.tau "Cut torque in the flange";
// Real gear1.adapter.flange_b.phi "Absolute rotation angle of flange";
// Real gear1.adapter.flange_b.tau "Cut torque in the flange";
// parameter Boolean gear1.adapter.bearingConnected = true;
// parameter Real gear1.ratio = 2 "transmission ratio (flange_a.phi/flange_b.phi)";
// parameter Real gear1.eta = 1 "Gear efficiency";
// parameter Real gear1.friction_pos[1,1] = 0 "[w,tau] positive sliding friction characteristic (w>=0)";
// parameter Real gear1.friction_pos[1,2] = 1 "[w,tau] positive sliding friction characteristic (w>=0)";
// parameter Real gear1.peak = 1 "peak*friction_pos[1,2] = maximum friction torque at zero velocity";
// parameter Real gear1.c = 100000.0 "Gear elasticity (spring constant)";
// parameter Real gear1.d = 0 "(relative) gear damping";
// parameter Real gear1.b = 0 "Total backlash";
// Real gear1.gearRatio.flange_a.phi "Absolute rotation angle of flange";
// Real gear1.gearRatio.flange_a.tau "Cut torque in the flange";
// Real gear1.gearRatio.flange_b.phi "Absolute rotation angle of flange";
// Real gear1.gearRatio.flange_b.tau "Cut torque in the flange";
// Real gear1.gearRatio.tau_support;
// Real gear1.gearRatio.bearing.phi "Absolute rotation angle of flange";
// Real gear1.gearRatio.bearing.tau "Cut torque in the flange";
// Real gear1.gearRatio.phi_a;
// Real gear1.gearRatio.phi_b;
// parameter Real gear1.gearRatio.ratio = gear1.ratio "Transmission ratio (flange_a.phi/flange_b.phi)";
// Real gear1.gearEfficiency.flange_a.phi "Absolute rotation angle of flange";
// Real gear1.gearEfficiency.flange_a.tau "Cut torque in the flange";
// Real gear1.gearEfficiency.flange_b.phi "Absolute rotation angle of flange";
// Real gear1.gearEfficiency.flange_b.tau "Cut torque in the flange";
// Real gear1.gearEfficiency.tau_support;
// Real gear1.gearEfficiency.bearing.phi "Absolute rotation angle of flange";
// Real gear1.gearEfficiency.bearing.tau "Cut torque in the flange";
// Real gear1.gearEfficiency.phi_a;
// Real gear1.gearEfficiency.phi_b;
// parameter Real gear1.gearEfficiency.eta = gear1.eta "Efficiency";
// Real gear1.gearEfficiency.phi;
// Real gear1.gearEfficiency.power_a "Energy flowing into flange_a (= power)";
// Boolean gear1.gearEfficiency.driving_a "True, if energy is flowing INTO and not out of flange flange_a";
// Real gear1.elastoBacklash.phi_rel(start = 0.0) "Relative rotation angle (= flange_b.phi - flange_a.phi)";
// Real gear1.elastoBacklash.tau "Torque between flanges (= flange_b.tau)";
// Real gear1.elastoBacklash.flange_a.phi "Absolute rotation angle of flange";
// Real gear1.elastoBacklash.flange_a.tau "Cut torque in the flange";
// Real gear1.elastoBacklash.flange_b.phi "Absolute rotation angle of flange";
// Real gear1.elastoBacklash.flange_b.tau "Cut torque in the flange";
// parameter Real gear1.elastoBacklash.b = gear1.b "Total backlash";
// parameter Real gear1.elastoBacklash.c = gear1.c "Spring constant (c > 0 required)";
// parameter Real gear1.elastoBacklash.phi_rel0 = 0 "Unstretched spring angle";
// parameter Real gear1.elastoBacklash.d = gear1.d "Damping constant";
// Real gear1.elastoBacklash.w_rel "Relative angular velocity between flange_b and flange_a";
// Real gear1.elastoBacklash.b2;
// constant Real gear1.elastoBacklash.b_min = 1e-10 "minimum backlash";
// Real gear1.bearingFriction.flange_a.phi "Absolute rotation angle of flange";
// Real gear1.bearingFriction.flange_a.tau "Cut torque in the flange";
// Real gear1.bearingFriction.flange_b.phi "Absolute rotation angle of flange";
// Real gear1.bearingFriction.flange_b.tau "Cut torque in the flange";
// Real gear1.bearingFriction.tau_support;
// Real gear1.bearingFriction.bearing.phi "Absolute rotation angle of flange";
// Real gear1.bearingFriction.bearing.tau "Cut torque in the flange";
// Real gear1.bearingFriction.phi_a;
// Real gear1.bearingFriction.phi_b;
// parameter Real gear1.bearingFriction.w_small = 10000000000.0 "Relative angular velocity near to zero if jumps due to a reinit(..) of the velocity can occur (set to low value only if such impulses can occur)";
// Real gear1.bearingFriction.w_relfric "Relative angular velocity between frictional surfaces";
// Real gear1.bearingFriction.a_relfric "Relative angular acceleration between frictional surfaces";
// Real gear1.bearingFriction.tau "Friction torque (positive, if directed in opposite direction of w_rel)";
// Real gear1.bearingFriction.tau0 "Friction torque for w=0 and forward sliding";
// Real gear1.bearingFriction.tau0_max "Maximum friction torque for w=0 and locked";
...
// parameter Real gear1.bearingFriction.tau_pos[1,1] "[w,tau] Positive sliding friction characteristic (w>=0)";
// parameter Real gear1.bearingFriction.tau_pos[1,2] "[w,tau] Positive sliding friction characteristic (w>=0)";
// parameter Real gear1.bearingFriction.peak = gear1.peak "peak*tau_pos[1,2] = Maximum friction torque for w==0";
// Real gear1.bearingFriction.phi;
// Real gear1.bearingFriction.w "Absolute angular velocity of flange_a and flange_b";
// Real gear1.bearingFriction.a "Absolute angular acceleration of flange_a and flange_b";
// equation
...
//   gear1.gearEfficiency.flange_b.tau = -if gear1.gearEfficiency.driving_a then gear1.gearEfficiency.eta * gear1.gearEfficiency.flange_a.tau else gear1.gearEfficiency.flange_a.tau * 1.0 / gear1.gearEfficiency.eta;
