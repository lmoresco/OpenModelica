...
// fclass Gear
// parameter Real fixed1.phi0(quantity = "Angle", unit = "rad", displayUnit = "deg") = 0 "Fixed offset angle of housing";
...
// parameter Real springDamper1.phi_rel0(quantity = "Angle", unit = "rad", displayUnit = "deg") = 0 "Unstretched spring angle";
...
// parameter Real inertia1.J(quantity = "MomentOfInertia", unit = "kg.m2") = 1 "Moment of inertia";
...
// parameter Real springDamper2.phi_rel0(quantity = "Angle", unit = "rad", displayUnit = "deg") = 0 "Unstretched spring angle";
...
// parameter Real sine1.freqHz(quantity = "Frequency", unit = "Hz") = 1 "Frequency of sine wave";
// parameter Real sine1.phase(quantity = "Angle", unit = "rad", displayUnit = "deg") = 0 "Phase of sine wave";
// parameter Real sine1.offset = 0 "Offset of output signal";
// parameter Real sine1.startTime(quantity = "Time", unit = "s") = 0 "Output = offset for time < startTime";
...
// parameter Real gear1.b(quantity = "Angle", unit = "rad", displayUnit = "deg", min = 0.0) = 0 "Total backlash";
...
// parameter Real gear1.elastoBacklash.phi_rel0(quantity = "Angle", unit = "rad", displayUnit = "deg") = 0 "Unstretched spring angle";
...
// Real gear1.elastoBacklash.b2(quantity = "Angle", unit = "rad", displayUnit = "deg");
// constant Real gear1.elastoBacklash.b_min(quantity = "Angle", unit = "rad", displayUnit = "deg") = 1e-10 "minimum backlash";
