...
// parameter Real springDamper1.c(unit = "N.m/rad", min = 0.0) = 10 "Spring constant";
// parameter Real springDamper1.phi_rel0 = 0 "Unstretched spring angle";
// parameter Real springDamper1.d(unit = "N.m.s/rad", min = 0.0) = 1 "Damping constant";
...
// parameter Real springDamper2.c(unit = "N.m/rad", min = 0.0) = 1000 "Spring constant";
// parameter Real springDamper2.phi_rel0 = 0 "Unstretched spring angle";
// parameter Real springDamper2.d(unit = "N.m.s/rad", min = 0.0) = 10 "Damping constant";
...
// parameter Real gear1.eta(min = 1e-60, max = 1.0) = 1 "Gear efficiency";
...
// parameter Real gear1.peak(min = 1.0) = 1 "peak*friction_pos[1,2] = maximum friction torque at zero velocity";
// parameter Real gear1.c(unit = "N.m/rad", min = 1e-60) = 100000.0 "Gear elasticity (spring constant)";
// parameter Real gear1.d(unit = "N.m.s/rad", min = 0.0) = 0 "(relative) gear damping";
// parameter Real gear1.b(min = 0.0) = 0 "Total backlash";
...
// parameter Real gear1.elastoBacklash.b(min = 0.0) = gear1.b "Total backlash";
