...
//   Real result[2];
//   Real result[3];
//   input Integer f1.foo1[1] = mod1[1];
//   input Integer f1.foo1[2] = mod1[2];
//   input Integer f1.foo1[3] = mod1[3];
//   input Integer f1.foo2[1] = mod2[1];
//   input Integer f1.foo2[2] = mod2[2];
//   input Integer f1.foo2[3] = mod2[3];
//   output Real f1.result[1];
//   output Real f1.result[2];
//   output Real f1.result[3];
// equation
