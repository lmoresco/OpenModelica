...
// class B
//   Real a1[1].x;
//   parameter Real a1[1].y = 1;
//   Real a1[2].x;
//   parameter Real a1[2].y = 2;
//   Real a1[3].x;
//   parameter Real a1[3].y = 3;
//   Real a2[1].x;
//   parameter Real a2[1].y = 4;
//   Real a2[2].x;
//   parameter Real a2[2].y = 4;
//   Real a2[3].x;
//   parameter Real a2[3].y = 4;
// equation
//   a1[1].x = a1[1].y * 3;
//   a1[1].y = a1[1].x;
//   a1[2].x = a1[2].y * 3;
...
// 
// 
// Found 6 components and 6 parameters.
// class B
//   Real a1[1].x;
