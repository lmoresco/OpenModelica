...
{
	literals["Magnification"] = 80;
	literals["CellAutoOverwrite"] = 79;
	literals["WindowMoveable"] = 54;
	literals["ParentDirectory"] = 81;
	literals["List"] = 5;
	literals["FrontEndVersion"] = 58;
	literals["SqrtBox"] = 28;
	literals["TextJustification"] = 37;
	literals["Editable"] = 46;
	literals["TextData"] = 8;
	literals["FontVariations"] = 35;
	literals["ButtonBox"] = 17;
	literals["WindowTitle"] = 52;
	literals["BoxData"] = 16;
	literals["WindowElements"] = 51;
	literals["FontFamily"] = 34;
	literals["FormBox"] = 18;
	literals["ImageSize"] = 73;
	literals["OutputForm"] = 69;
	literals["Null"] = 70;
	literals["ScreenRectangle"] = 42;
	literals["ImageMargins"] = 74;
	literals["Open"] = 59;
	literals["RowBox"] = 19;
	literals["WindowFrame"] = 50;
	literals["FrontEnd"] = 4;
	literals["CellFrame"] = 45;
	literals["ImageCache"] = 77;
	literals["False"] = 64;
	literals["CellTags"] = 44;
	literals["ButtonStyle"] = 40;
	literals["UnderscriptBox"] = 24;
	literals["SuperscriptBox"] = 21;
	literals["RGBColor"] = 13;
	literals["WindowToolbars"] = 53;
	literals["None"] = 71;
	literals["Closed"] = 60;
	literals["Background"] = 47;
	literals["FileName"] = 14;
	literals["SubscriptBox"] = 22;
	literals["TraditionalForm"] = 66;
	literals["Right"] = 61;
	literals["ButtonData"] = 39;
	literals["StandardForm"] = 67;
	literals["ImageRangeCache"] = 76;
	literals["FontSlant"] = 30;
	literals["WindowMargins"] = 49;
	literals["ImageRegion"] = 75;
	literals["WindowClickSelect"] = 56;
	literals["WindowSize"] = 48;
	literals["GridBox"] = 20;
	literals["GenerateCell"] = 78;
	literals["GrayLevel"] = 12;
	literals["Notebook"] = 6;
	literals["Rule"] = 10;
	literals["UnderoverscriptBox"] = 26;
	literals["StyleDefinitions"] = 57;
	literals["FontColor"] = 32;
	literals["AutoGeneratedPackage"] = 43;
	literals["Left"] = 62;
	literals["GraphicsData"] = 72;
	literals["TextAlignment"] = 36;
	literals["RuleDelayed"] = 11;
	literals["InitializationCell"] = 38;
	literals["FractionBox"] = 27;
	literals["CellGroupData"] = 9;
	literals["SubsuperscriptBox"] = 23;
	literals["Automatic"] = 65;
	literals["FontSize"] = 31;
	literals["WindowFloating"] = 55;
	literals["StyleBox"] = 15;
	literals["OverscriptBox"] = 25;
	literals["RadicalBox"] = 29;
	literals["Cell"] = 7;
	literals["True"] = 63;
	literals["FontWeight"] = 33;
	literals["InputForm"] = 68;
	literals["CharacterEncoding"] = 41;
}
